...
`],...Nf(n))}),e}function Nf({vnode:t,recurseCount:e}){const n=e>0?`... (${e} recursive calls)`:"",s=t.component?t.component.parent==null:!1,r=` at <${ul(t.component,t.type,s)}`,i=">"+n;return t.props?[r,...Hf(t.props),i]:[r+i]}function Hf(t){const e=[],n=Object.keys(t);return n.slice(0,3).forEach(s=>{e.push(...wa(s,t[s]))}),n.length>3&&e.push(" ..."),e}function wa(t,e,n){return ke(e)?(e=JSON.stringify(e),n?e:[`${t}=${e}`]):typeof e=="number"||typeof e=="boolean"||e==null?n?e:[`${t}=${e}`]:ce(e)?(e=wa(t,K(e.value),!0),n?e:[`${t}=Ref<`,e,">"]):U(e)?[`${t}=fn${e.name?`<${e.name}>`:""}`]:(e=K(e),n?e:[`${t}=`,e])}function Zt(t,e,n,s){try{return s?t(...s):t()}catch(r){Es(r,e,n)}}function Ye(t,e,n,s){if(U(t)){const r=Zt(t,e,n,s);return r&&ha(r)&&r.catch(i=>{Es(i,e,n)}),r}if(G(t)){const r=[];for(let i=0;i<t.length;i++)r.push(Ye(t[i],e,n,s));return r}}function Es(t,e,n,s=!0){const r=e?e.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:o}=e&&e.appContext.config||ae;if(e){let a=e.parent;const l=e.proxy,u=`https://vuejs.org/error-reference/#runtime-${n}`;for(;a;){const c=a.ec;if(c){for(let h=0;h<c.length;h++)if(c[h](t,l,u)===!1)return}a=a.parent}if(i){at(),Zt(i,null,10,[t,l,u]),lt();return}}Vf(t,n,r,s,o)}function Vf(t,e,n,s=!0,r=!1){if(r)throw t;console.error(t)}let $n=!1,gi=!1;const Me=[];let Ft=0;const Qt=[];let Ct=null,Yt=0;const ba=Promise.resolve();let mi=null;function _i(t){const e=mi||ba;return t?e.then(this?t.bind(this):t):e}function Uf(t){let e=$n?Ft+1:0,n=Me.length;for(;e<n;){const s=e+n>>>1,r=Me[s],i=Mn(r);i<t||i===t&&r.flags&2?e=s+1:n=s}return e}function wi(t){if(!(t.flags&1)){const e=Mn(t),n=Me[Me.length-1];!n||!(t.flags&2)&&e>=Mn(n)?Me.push(t):Me.splice(Uf(e),0,t),t.flags&4||(t.flags|=1),ya()}}function ya(){!$n&&!gi&&(gi=!0,mi=ba.then(Ca))}function zf(t){G(t)?Qt.push(...t):Ct&&t.id===-1?Ct.splice(Yt+1,0,t):t.flags&1||(Qt.push(t),t.flags&4||(t.flags|=1)),ya()}function xa(t,e,n=$n?Ft+1:0){for(;n<Me.length;n++){const s=Me[n];if(s&&s.flags&2){if(t&&s.id!==t.uid)continue;Me.splice(n,1),n--,s(),s.flags&=-2}}}function va(t){if(Qt.length){const e=[...new Set(Qt)].sort((n,s)=>Mn(n)-Mn(s));if(Qt.length=0,Ct){Ct.push(...e);return}for(Ct=e,Yt=0;Yt<Ct.length;Yt++){const n=Ct[Yt];n.flags&8||n(),n.flags&=-2}Ct=null,Yt=0}}const Mn=t=>t.id==null?t.flags&2?-1:1/0:t.id;function Ca(t){gi=!1,$n=!0;try{for(Ft=0;Ft<Me.length;Ft++){const e=Me[Ft];e&&!(e.flags&8)&&(Zt(e,e.i,e.i?15:14),e.flags&=-2)}}finally{Ft=0,Me.length=0,va(),$n=!1,mi=null,(Me.length||Qt.length)&&Ca()}}let Te=null,ka=null;function As(t){const e=Te;return Te=t,ka=t&&t.type.__scopeId||null,e}function Wf(t,e=Te,n){if(!e||t._n)return t;const s=(...r)=>{s._d&&tl(-1);const i=As(e);let o;try{o=t(...r)}finally{As(i),s._d&&tl(1)}return o};return s._n=!0,s._c=!0,s._d=!0,s}function Ps(t,e){if(Te===null)return t;const n=js(Te),s=t.dirs||(t.dirs=[]);for(let r=0;r<e.length;r++){let[i,o,a,l=ae]=e[r];i&&(U(i)&&(i={mounted:i,updated:i}),i.deep&&ft(o),s.push({dir:i,instance:n,value:o,oldValue:void 0,arg:a,modifiers:l}))}return t}function Lt(t,e,n,s){const r=t.dirs,i=e&&e.dirs;for(let o=0;o<r.length;o++){const a=r[o];i&&(a.oldValue=i[o].value);let l=a.dir[s];l&&(at(),Ye(l,n,8,[t.el,a,t,e]),lt())}}const qf=Symbol("_vte"),Kf=t=>t.__isTeleport;function Sa(t,e){t.shapeFlag&6&&t.component?Sa(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}/*! #__NO_SIDE_EFFECTS__ */function Tn(t,e){return U(t)?ye({name:t.name},e,{setup:t}):t}function Ea(t){t.ids=[t.ids[0]+t.ids[2]+++"-",0,0]}function bi(t,e,n,s,r=!1){if(G(t)){t.forEach((p,m)=>bi(p,e&&(G(e)?e[m]:e),n,s,r));return}if(In(s)&&!r)return;const i=s.shapeFlag&4?js(s.component):s.el,o=r?null:i,{i:a,r:l}=t,u=e&&e.r,c=a.refs===ae?a.refs={}:a.refs,h=a.setupState;if(u!=null&&u!==l&&(ke(u)?(c[u]=null,Q(h,u)&&(h[u]=null)):ce(u)&&(u.value=null)),U(l))Zt(l,a,12,[o,c]);else{const p=ke(l),m=ce(l);if(p||m){const E=()=>{if(t.f){const y=p?Q(h,l)?h[l]:c[l]:l.value;r?G(y)&&ua(y,i):G(y)?y.includes(i)||y.push(i):p?(c[l]=[i],Q(h,l)&&(h[l]=c[l])):(l.value=[i],t.k&&(c[t.k]=l.value))}else p?(c[l]=o,Q(h,l)&&(h[l]=o)):m&&(l.value=o,t.k&&(c[t.k]=o))};o?(E.id=-1,Ie(E,n)):E()}}}const In=t=>!!t.type.__asyncLoader,Aa=t=>t.type.__isKeepAlive;function Gf(t,e){Pa(t,"a",e)}function Jf(t,e){Pa(t,"da",e)}function Pa(t,e,n=xe){const s=t.__wdc||(t.__wdc=()=>{let r=n;for(;r;){if(r.isDeactivated)return;r=r.parent}return t()});if(Rs(e,s,n),n){let r=n.parent;for(;r&&r.parent;)Aa(r.parent.vnode)&&Xf(s,e,n,r),r=r.parent}}function Xf(t,e,n,s){const r=Rs(e,t,s,!0);$a(()=>{ua(s[e],r)},n)}function Rs(t,e,n=xe,s=!1){if(n){const r=n[t]||(n[t]=[]),i=e.__weh||(e.__weh=(...o)=>{at();const a=Bn(n),l=Ye(e,n,t,o);return a(),lt(),l});return s?r.unshift(i):r.push(i),i}}const dt=t=>(e,n=xe)=>{(!Ls||t==="sp")&&Rs(t,(...s)=>e(...s),n)},Zf=dt("bm"),Ra=dt("m"),Qf=dt("bu"),Yf=dt("u"),eh=dt("bum"),$a=dt("um"),th=dt("sp"),nh=dt("rtg"),sh=dt("rtc");function rh(t,e=xe){Rs("ec",t,e)}const ih=Symbol.for("v-ndc");function yi(t,e,n,s){let r;const i=n,o=G(t);if(o||ke(t)){const a=o&&vt(t);a&&(t=ps(t)),r=new Array(t.length);for(let l=0,u=t.length;l<u;l++)r[l]=e(a?be(t[l]):t[l],l,void 0,i)}else if(typeof t=="number"){r=new Array(t);for(let a=0;a<t;a++)r[a]=e(a+1,a,void 0,i)}else if(pe(t))if(t[Symbol.iterator])r=Array.from(t,(a,l)=>e(a,l,void 0,i));else{const a=Object.keys(t);r=new Array(a.length);for(let l=0,u=a.length;l<u;l++){const c=a[l];r[l]=e(t[c],c,l,i)}}else r=[];return r}const xi=t=>t?ol(t)?js(t):xi(t.parent):null,On=ye(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>xi(t.parent),$root:t=>xi(t.root),$host:t=>t.ce,$emit:t=>t.emit,$options:t=>ki(t),$forceUpdate:t=>t.f||(t.f=()=>{wi(t.update)}),$nextTick:t=>t.n||(t.n=_i.bind(t.proxy)),$watch:t=>Ph.bind(t)}),vi=(t,e)=>t!==ae&&!t.__isScriptSetup&&Q(t,e),oh={get({_:t},e){if(e==="__v_skip")return!0;const{ctx:n,setupState:s,data:r,props:i,accessCache:o,type:a,appContext:l}=t;let u;if(e[0]!=="$"){const m=o[e];if(m!==void 0)switch(m){case 1:return s[e];case 2:return r[e];case 4:return n[e];case 3:return i[e]}else{if(vi(s,e))return o[e]=1,s[e];if(r!==ae&&Q(r,e))return o[e]=2,r[e];if((u=t.propsOptions[0])&&Q(u,e))return o[e]=3,i[e];if(n!==ae&&Q(n,e))return o[e]=4,n[e];Ci&&(o[e]=0)}}const c=On[e];let h,p;if(c)return e==="$attrs"&&we(t.attrs,"get",""),c(t);if((h=a.__cssModules)&&(h=h[e]))return h;if(n!==ae&&Q(n,e))return o[e]=4,n[e];if(p=l.config.globalProperties,Q(p,e))return p[e]},set({_:t},e,n){const{data:s,setupState:r,ctx:i}=t;return vi(r,e)?(r[e]=n,!0):s!==ae&&Q(s,e)?(s[e]=n,!0):Q(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(i[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:s,appContext:r,propsOptions:i}},o){let a;return!!n[o]||t!==ae&&Q(t,o)||vi(e,o)||(a=i[0])&&Q(a,o)||Q(s,o)||Q(On,o)||Q(r.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:Q(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function Ma(t){return G(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let Ci=!0;function ah(t){const e=ki(t),n=t.proxy,s=t.ctx;Ci=!1,e.beforeCreate&&Ta(e.beforeCreate,t,"bc");const{data:r,computed:i,methods:o,watch:a,provide:l,inject:u,created:c,beforeMount:h,mounted:p,beforeUpdate:m,updated:E,activated:y,deactivated:S,beforeDestroy:I,beforeUnmount:x,destroyed:w,unmounted:_,render:$,renderTracked:N,renderTriggered:j,errorCaptured:H,serverPrefetch:D,expose:X,inheritAttrs:J,components:$e,directives:Pt,filters:as}=e;if(u&&lh(u,s,null),o)for(const W in o){const ie=o[W];U(ie)&&(s[W]=ie.bind(n))}if(r){const W=r.call(n,n);pe(W)&&(t.data=Sn(W))}if(Ci=!0,i)for(const W in i){const ie=i[W],qt=U(ie)?ie.bind(n,n):U(ie.get)?ie.get.bind(n,n):ht,zr=!U(ie)&&U(ie.set)?ie.set.bind(n):ht,Kt=Ii({get:qt,set:zr});Object.defineProperty(s,W,{enumerable:!0,configurable:!0,get:()=>Kt.value,set:rt=>Kt.value=rt})}if(a)for(const W in a)Ia(a[W],s,n,W);if(l){const W=U(l)?l.call(n):l;Reflect.ownKeys(W).forEach(ie=>{ph(ie,W[ie])})}c&&Ta(c,t,"c");function fe(W,ie){G(ie)?ie.forEach(qt=>W(qt.bind(n))):ie&&W(ie.bind(n))}if(fe(Zf,h),fe(Ra,p),fe(Qf,m),fe(Yf,E),fe(Gf,y),fe(Jf,S),fe(rh,H),fe(sh,N),fe(nh,j),fe(eh,x),fe($a,_),fe(th,D),G(X))if(X.length){const W=t.exposed||(t.exposed={});X.forEach(ie=>{Object.defineProperty(W,ie,{get:()=>n[ie],set:qt=>n[ie]=qt})})}else t.exposed||(t.exposed={});$&&t.render===ht&&(t.render=$),J!=null&&(t.inheritAttrs=J),$e&&(t.components=$e),Pt&&(t.directives=Pt),D&&Ea(t)}function lh(t,e,n=ht){G(t)&&(t=Si(t));for(const s in t){const r=t[s];let i;pe(r)?"default"in r?i=en(r.from||s,r.default,!0):i=en(r.from||s):i=en(r),ce(i)?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>i.value,set:o=>i.value=o}):e[s]=i}}function Ta(t,e,n){Ye(G(t)?t.map(s=>s.bind(e.proxy)):t.bind(e.proxy),e,n)}function Ia(t,e,n,s){let r=s.includes(".")?Za(n,s):()=>n[s];if(ke(t)){const i=e[t];U(i)&&Ms(r,i)}else if(U(t))Ms(r,t.bind(n));else if(pe(t))if(G(t))t.forEach(i=>Ia(i,e,n,s));else{const i=U(t.handler)?t.handler.bind(n):e[t.handler];U(i)&&Ms(r,i,t)}}function ki(t){const e=t.type,{mixins:n,extends:s}=e,{mixins:r,optionsCache:i,config:{optionMergeStrategies:o}}=t.appContext,a=i.get(e);let l;return a?l=a:!r.length&&!n&&!s?l=e:(l={},r.length&&r.forEach(u=>$s(l,u,o,!0)),$s(l,e,o)),pe(e)&&i.set(e,l),l}function $s(t,e,n,s=!1){const{mixins:r,extends:i}=e;i&&$s(t,i,n,!0),r&&r.forEach(o=>$s(t,o,n,!0));for(const o in e)if(!(s&&o==="expose")){const a=ch[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const ch={data:Oa,props:Fa,emits:Fa,methods:Fn,computed:Fn,beforeCreate:Se,created:Se,beforeMount:Se,mounted:Se,beforeUpdate:Se,updated:Se,beforeDestroy:Se,beforeUnmount:Se,destroyed:Se,unmounted:Se,activated:Se,deactivated:Se,errorCaptured:Se,serverPrefetch:Se,components:Fn,directives:Fn,watch:fh,provide:Oa,inject:uh};function Oa(t,e){return e?t?function(){return ye(U(t)?t.call(this,this):t,U(e)?e.call(this,this):e)}:e:t}function uh(t,e){return Fn(Si(t),Si(e))}function Si(t){if(G(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function Se(t,e){return t?[...new Set([].concat(t,e))]:e}function Fn(t,e){return t?ye(Object.create(null),t,e):e}function Fa(t,e){return t?G(t)&&G(e)?[...new Set([...t,...e])]:ye(Object.create(null),Ma(t),Ma(e??{})):e}function fh(t,e){if(!t)return e;if(!e)return t;const n=ye(Object.create(null),t);for(const s in e)n[s]=Se(t[s],e[s]);return n}function La(){return{app:null,config:{isNativeTag:kf,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let hh=0;function dh(t,e){return function(s,r=null){U(s)||(s=ye({},s)),r!=null&&!pe(r)&&(r=null);const i=La(),o=new WeakSet,a=[];let l=!1;const u=i.app={_uid:hh++,_component:s,_props:r,_container:null,_context:i,_instance:null,version:Yh,get config(){return i.config},set config(c){},use(c,...h){return o.has(c)||(c&&U(c.install)?(o.add(c),c.install(u,...h)):U(c)&&(o.add(c),c(u,...h))),u},mixin(c){return i.mixins.includes(c)||i.mixins.push(c),u},component(c,h){return h?(i.components[c]=h,u):i.components[c]},directive(c,h){return h?(i.directives[c]=h,u):i.directives[c]},mount(c,h,p){if(!l){const m=u._ceVNode||Pe(s,r);return m.appContext=i,p===!0?p="svg":p===!1&&(p=void 0),h&&e?e(m,c):t(m,c,p),l=!0,u._container=c,c.__vue_app__=u,js(m.component)}},onUnmount(c){a.push(c)},unmount(){l&&(Ye(a,u._instance,16),t(null,u._container),delete u._container.__vue_app__)},provide(c,h){return i.provides[c]=h,u},runWithContext(c){const h=jt;jt=u;try{return c()}finally{jt=h}}};return u}}let jt=null;function ph(t,e){if(xe){let n=xe.provides;const s=xe.parent&&xe.parent.provides;s===n&&(n=xe.provides=Object.create(s)),n[t]=e}}function en(t,e,n=!1){const s=xe||Te;if(s||jt){const r=jt?jt._context.provides:s?s.parent==null?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:void 0;if(r&&t in r)return r[t];if(arguments.length>1)return n&&U(e)?e.call(s&&s.proxy):e}}function gh(){return!!(xe||Te||jt)}const ja={},Da=()=>Object.create(ja),Ba=t=>Object.getPrototypeOf(t)===ja;function mh(t,e,n,s=!1){const r={},i=Da();t.propsDefaults=Object.create(null),Na(t,e,r,i);for(const o in t.propsOptions[0])o in r||(r[o]=void 0);n?t.props=s?r:hf(r):t.type.props?t.props=r:t.props=i,t.attrs=i}function _h(t,e,n,s){const{props:r,attrs:i,vnode:{patchFlag:o}}=t,a=K(r),[l]=t.propsOptions;let u=!1;if((s||o>0)&&!(o&16)){if(o&8){const c=t.vnode.dynamicProps;for(let h=0;h<c.length;h++){let p=c[h];if(Ts(t.emitsOptions,p))continue;const m=e[p];if(l)if(Q(i,p))m!==i[p]&&(i[p]=m,u=!0);else{const E=It(p);r[E]=Ei(l,a,E,m,t,!1)}else m!==i[p]&&(i[p]=m,u=!0)}}}else{Na(t,e,r,i)&&(u=!0);let c;for(const h in a)(!e||!Q(e,h)&&((c=An(h))===h||!Q(e,c)))&&(l?n&&(n[h]!==void 0||n[c]!==void 0)&&(r[h]=Ei(l,a,h,void 0,t,!0)):delete r[h]);if(i!==a)for(const h in i)(!e||!Q(e,h))&&(delete i[h],u=!0)}u&&ct(t.attrs,"set","")}function Na(t,e,n,s){const[r,i]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(En(l))continue;const u=e[l];let c;r&&Q(r,c=It(l))?!i||!i.includes(c)?n[c]=u:(a||(a={}))[c]=u:Ts(t.emitsOptions,l)||(!(l in s)||u!==s[l])&&(s[l]=u,o=!0)}if(i){const l=K(n),u=a||ae;for(let c=0;c<i.length;c++){const h=i[c];n[h]=Ei(r,l,h,u[h],t,!Q(u,h))}}return o}function Ei(t,e,n,s,r,i){const o=t[n];if(o!=null){const a=Q(o,"default");if(a&&s===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&U(l)){const{propsDefaults:u}=r;if(n in u)s=u[n];else{const c=Bn(r);s=u[n]=l.call(null,e),c()}}else s=l;r.ce&&r.ce._setProp(n,s)}o[0]&&(i&&!a?s=!1:o[1]&&(s===""||s===An(n))&&(s=!0))}return s}const wh=new WeakMap;function Ha(t,e,n=!1){const s=n?wh:e.propsCache,r=s.get(t);if(r)return r;const i=t.props,o={},a=[];let l=!1;if(!U(t)){const c=h=>{l=!0;const[p,m]=Ha(h,e,!0);ye(o,p),m&&a.push(...m)};!n&&e.mixins.length&&e.mixins.forEach(c),t.extends&&c(t.extends),t.mixins&&t.mixins.forEach(c)}if(!i&&!l)return pe(t)&&s.set(t,Xt),Xt;if(G(i))for(let c=0;c<i.length;c++){const h=It(i[c]);Va(h)&&(o[h]=ae)}else if(i)for(const c in i){const h=It(c);if(Va(h)){const p=i[c],m=o[h]=G(p)||U(p)?{type:p}:ye({},p),E=m.type;let y=!1,S=!0;if(G(E))for(let I=0;I<E.length;++I){const x=E[I],w=U(x)&&x.name;if(w==="Boolean"){y=!0;break}else w==="String"&&(S=!1)}else y=U(E)&&E.name==="Boolean";m[0]=y,m[1]=S,(y||Q(m,"default"))&&a.push(h)}}const u=[o,a];return pe(t)&&s.set(t,u),u}function Va(t){return t[0]!=="$"&&!En(t)}const Ua=t=>t[0]==="_"||t==="$stable",Ai=t=>G(t)?t.map(et):[et(t)],bh=(t,e,n)=>{if(e._n)return e;const s=Wf((...r)=>Ai(e(...r)),n);return s._c=!1,s},za=(t,e,n)=>{const s=t._ctx;for(const r in t){if(Ua(r))continue;const i=t[r];if(U(i))e[r]=bh(r,i,s);else if(i!=null){const o=Ai(i);e[r]=()=>o}}},Wa=(t,e)=>{const n=Ai(e);t.slots.default=()=>n},qa=(t,e,n)=>{for(const s in e)(n||s!=="_")&&(t[s]=e[s])},yh=(t,e,n)=>{const s=t.slots=Da();if(t.vnode.shapeFlag&32){const r=e._;r?(qa(s,e,n),n&&Tf(s,"_",r,!0)):za(e,s)}else e&&Wa(t,e)},xh=(t,e,n)=>{const{vnode:s,slots:r}=t;let i=!0,o=ae;if(s.shapeFlag&32){const a=e._;a?n&&a===1?i=!1:qa(r,e,n):(i=!e.$stable,za(e,r)),o=e}else e&&(Wa(t,e),o={default:1});if(i)for(const a in r)!Ua(a)&&o[a]==null&&delete r[a]},Ie=Fh;function vh(t){return Ch(t)}function Ch(t,e){const n=ga();n.__VUE__=!0;const{insert:s,remove:r,patchProp:i,createElement:o,createText:a,createComment:l,setText:u,setElementText:c,parentNode:h,nextSibling:p,setScopeId:m=ht,insertStaticContent:E}=t,y=(f,d,g,C=null,b=null,v=null,R=void 0,P=null,A=!!d.dynamicChildren)=>{if(f===d)return;f&&!Dn(f,d)&&(C=Wr(f),rt(f,b,v,!0),f=null),d.patchFlag===-2&&(A=!1,d.dynamicChildren=null);const{type:k,ref:B,shapeFlag:T}=d;switch(k){case Is:S(f,d,g,C);break;case Bt:I(f,d,g,C);break;case $i:f==null&&x(d,g,C,R);break;case Ve:$e(f,d,g,C,b,v,R,P,A);break;default:T&1?$(f,d,g,C,b,v,R,P,A):T&6?Pt(f,d,g,C,b,v,R,P,A):(T&64||T&128)&&k.process(f,d,g,C,b,v,R,P,A,cs)}B!=null&&b&&bi(B,f&&f.ref,v,d||f,!d)},S=(f,d,g,C)=>{if(f==null)s(d.el=a(d.children),g,C);else{const b=d.el=f.el;d.children!==f.children&&u(b,d.children)}},I=(f,d,g,C)=>{f==null?s(d.el=l(d.children||""),g,C):d.el=f.el},x=(f,d,g,C)=>{[f.el,f.anchor]=E(f.children,d,g,C,f.el,f.anchor)},w=({el:f,anchor:d},g,C)=>{let b;for(;f&&f!==d;)b=p(f),s(f,g,C),f=b;s(d,g,C)},_=({el:f,anchor:d})=>{let g;for(;f&&f!==d;)g=p(f),r(f),f=g;r(d)},$=(f,d,g,C,b,v,R,P,A)=>{d.type==="svg"?R="svg":d.type==="math"&&(R="mathml"),f==null?N(d,g,C,b,v,R,P,A):D(f,d,b,v,R,P,A)},N=(f,d,g,C,b,v,R,P)=>{let A,k;const{props:B,shapeFlag:T,transition:L,dirs:V}=f;if(A=f.el=o(f.type,v,B&&B.is,B),T&8?c(A,f.children):T&16&&H(f.children,A,null,C,b,Pi(f,v),R,P),V&&Lt(f,null,C,"created"),j(A,f,f.scopeId,R,C),B){for(const oe in B)oe!=="value"&&!En(oe)&&i(A,oe,null,B[oe],v,C);"value"in B&&i(A,"value",null,B.value,v),(k=B.onVnodeBeforeMount)&&tt(k,C,f)}V&&Lt(f,null,C,"beforeMount");const q=kh(b,L);q&&L.beforeEnter(A),s(A,d,g),((k=B&&B.onVnodeMounted)||q||V)&&Ie(()=>{k&&tt(k,C,f),q&&L.enter(A),V&&Lt(f,null,C,"mounted")},b)},j=(f,d,g,C,b)=>{if(g&&m(f,g),C)for(let v=0;v<C.length;v++)m(f,C[v]);if(b){let v=b.subTree;if(d===v||el(v.type)&&(v.ssContent===d||v.ssFallback===d)){const R=b.vnode;j(f,R,R.scopeId,R.slotScopeIds,b.parent)}}},H=(f,d,g,C,b,v,R,P,A=0)=>{for(let k=A;k<f.length;k++){const B=f[k]=P?kt(f[k]):et(f[k]);y(null,B,d,g,C,b,v,R,P)}},D=(f,d,g,C,b,v,R)=>{const P=d.el=f.el;let{patchFlag:A,dynamicChildren:k,dirs:B}=d;A|=f.patchFlag&16;const T=f.props||ae,L=d.props||ae;let V;if(g&&Dt(g,!1),(V=L.onVnodeBeforeUpdate)&&tt(V,g,d,f),B&&Lt(d,f,g,"beforeUpdate"),g&&Dt(g,!0),(T.innerHTML&&L.innerHTML==null||T.textContent&&L.textContent==null)&&c(P,""),k?X(f.dynamicChildren,k,P,g,C,Pi(d,b),v):R||ie(f,d,P,null,g,C,Pi(d,b),v,!1),A>0){if(A&16)J(P,T,L,g,b);else if(A&2&&T.class!==L.class&&i(P,"class",null,L.class,b),A&4&&i(P,"style",T.style,L.style,b),A&8){const q=d.dynamicProps;for(let oe=0;oe<q.length;oe++){const te=q[oe],Be=T[te],Ee=L[te];(Ee!==Be||te==="value")&&i(P,te,Be,Ee,b,g)}}A&1&&f.children!==d.children&&c(P,d.children)}else!R&&k==null&&J(P,T,L,g,b);((V=L.onVnodeUpdated)||B)&&Ie(()=>{V&&tt(V,g,d,f),B&&Lt(d,f,g,"updated")},C)},X=(f,d,g,C,b,v,R)=>{for(let P=0;P<d.length;P++){const A=f[P],k=d[P],B=A.el&&(A.type===Ve||!Dn(A,k)||A.shapeFlag&70)?h(A.el):g;y(A,k,B,null,C,b,v,R,!0)}},J=(f,d,g,C,b)=>{if(d!==g){if(d!==ae)for(const v in d)!En(v)&&!(v in g)&&i(f,v,d[v],null,b,C);for(const v in g){if(En(v))continue;const R=g[v],P=d[v];R!==P&&v!=="value"&&i(f,v,P,R,b,C)}"value"in g&&i(f,"value",d.value,g.value,b)}},$e=(f,d,g,C,b,v,R,P,A)=>{const k=d.el=f?f.el:a(""),B=d.anchor=f?f.anchor:a("");let{patchFlag:T,dynamicChildren:L,slotScopeIds:V}=d;V&&(P=P?P.concat(V):V),f==null?(s(k,g,C),s(B,g,C),H(d.children||[],g,B,b,v,R,P,A)):T>0&&T&64&&L&&f.dynamicChildren?(X(f.dynamicChildren,L,g,b,v,R,P),(d.key!=null||b&&d===b.subTree)&&Ka(f,d,!0)):ie(f,d,g,B,b,v,R,P,A)},Pt=(f,d,g,C,b,v,R,P,A)=>{d.slotScopeIds=P,f==null?d.shapeFlag&512?b.ctx.activate(d,g,C,R,A):as(d,g,C,b,v,R,A):Ur(f,d,A)},as=(f,d,g,C,b,v,R)=>{const P=f.component=zh(f,C,b);if(Aa(f)&&(P.ctx.renderer=cs),Wh(P,!1,R),P.asyncDep){if(b&&b.registerDep(P,fe,R),!f.el){const A=P.subTree=Pe(Bt);I(null,A,d,g)}}else fe(P,f,d,g,b,v,R)},Ur=(f,d,g)=>{const C=d.component=f.component;if(Ih(f,d,g))if(C.asyncDep&&!C.asyncResolved){W(C,d,g);return}else C.next=d,C.update();else d.el=f.el,C.vnode=d},fe=(f,d,g,C,b,v,R)=>{const P=()=>{if(f.isMounted){let{next:T,bu:L,u:V,parent:q,vnode:oe}=f;{const Ne=Ga(f);if(Ne){T&&(T.el=oe.el,W(f,T,R)),Ne.asyncDep.then(()=>{f.isUnmounted||P()});return}}let te=T,Be;Dt(f,!1),T?(T.el=oe.el,W(f,T,R)):T=oe,L&&fi(L),(Be=T.props&&T.props.onVnodeBeforeUpdate)&&tt(Be,q,T,oe),Dt(f,!0);const Ee=Ri(f),Qe=f.subTree;f.subTree=Ee,y(Qe,Ee,h(Qe.el),Wr(Qe),f,b,v),T.el=Ee.el,te===null&&Oh(f,Ee.el),V&&Ie(V,b),(Be=T.props&&T.props.onVnodeUpdated)&&Ie(()=>tt(Be,q,T,oe),b)}else{let T;const{el:L,props:V}=d,{bm:q,m:oe,parent:te,root:Be,type:Ee}=f,Qe=In(d);if(Dt(f,!1),q&&fi(q),!Qe&&(T=V&&V.onVnodeBeforeMount)&&tt(T,te,d),Dt(f,!0),L&&$u){const Ne=()=>{f.subTree=Ri(f),$u(L,f.subTree,f,b,null)};Qe?Ee.__asyncHydrate(L,f,Ne):Ne()}else{Be.ce&&Be.ce._injectChildStyle(Ee);const Ne=f.subTree=Ri(f);y(null,Ne,g,C,f,b,v),d.el=Ne.el}if(oe&&Ie(oe,b),!Qe&&(T=V&&V.onVnodeMounted)){const Ne=d;Ie(()=>tt(T,te,Ne),b)}(d.shapeFlag&256||te&&In(te.vnode)&&te.vnode.shapeFlag&256)&&f.a&&Ie(f.a,b),f.isMounted=!0,d=g=C=null}};f.scope.on();const A=f.effect=new Ho(P);f.scope.off();const k=f.update=A.run.bind(A),B=f.job=A.runIfDirty.bind(A);B.i=f,B.id=f.uid,A.scheduler=()=>wi(B),Dt(f,!0),k()},W=(f,d,g)=>{d.component=f;const C=f.vnode.props;f.vnode=d,f.next=null,_h(f,d.props,C,g),xh(f,d.children,g),at(),xa(f),lt()},ie=(f,d,g,C,b,v,R,P,A=!1)=>{const k=f&&f.children,B=f?f.shapeFlag:0,T=d.children,{patchFlag:L,shapeFlag:V}=d;if(L>0){if(L&128){zr(k,T,g,C,b,v,R,P,A);return}else if(L&256){qt(k,T,g,C,b,v,R,P,A);return}}V&8?(B&16&&ls(k,b,v),T!==k&&c(g,T)):B&16?V&16?zr(k,T,g,C,b,v,R,P,A):ls(k,b,v,!0):(B&8&&c(g,""),V&16&&H(T,g,C,b,v,R,P,A))},qt=(f,d,g,C,b,v,R,P,A)=>{f=f||Xt,d=d||Xt;const k=f.length,B=d.length,T=Math.min(k,B);let L;for(L=0;L<T;L++){const V=d[L]=A?kt(d[L]):et(d[L]);y(f[L],V,g,null,b,v,R,P,A)}k>B?ls(f,b,v,!0,!1,T):H(d,g,C,b,v,R,P,A,T)},zr=(f,d,g,C,b,v,R,P,A)=>{let k=0;const B=d.length;let T=f.length-1,L=B-1;for(;k<=T&&k<=L;){const V=f[k],q=d[k]=A?kt(d[k]):et(d[k]);if(Dn(V,q))y(V,q,g,null,b,v,R,P,A);else break;k++}for(;k<=T&&k<=L;){const V=f[T],q=d[L]=A?kt(d[L]):et(d[L]);if(Dn(V,q))y(V,q,g,null,b,v,R,P,A);else break;T--,L--}if(k>T){if(k<=L){const V=L+1,q=V<B?d[V].el:C;for(;k<=L;)y(null,d[k]=A?kt(d[k]):et(d[k]),g,q,b,v,R,P,A),k++}}else if(k>L)for(;k<=T;)rt(f[k],b,v,!0),k++;else{const V=k,q=k,oe=new Map;for(k=q;k<=L;k++){const He=d[k]=A?kt(d[k]):et(d[k]);He.key!=null&&oe.set(He.key,k)}let te,Be=0;const Ee=L-q+1;let Qe=!1,Ne=0;const us=new Array(Ee);for(k=0;k<Ee;k++)us[k]=0;for(k=V;k<=T;k++){const He=f[k];if(Be>=Ee){rt(He,b,v,!0);continue}let it;if(He.key!=null)it=oe.get(He.key);else for(te=q;te<=L;te++)if(us[te-q]===0&&Dn(He,d[te])){it=te;break}it===void 0?rt(He,b,v,!0):(us[it-q]=k+1,it>=Ne?Ne=it:Qe=!0,y(He,d[it],g,null,b,v,R,P,A),Be++)}const Mu=Qe?Sh(us):Xt;for(te=Mu.length-1,k=Ee-1;k>=0;k--){const He=q+k,it=d[He],Tu=He+1<B?d[He+1].el:C;us[k]===0?y(null,it,g,Tu,b,v,R,P,A):Qe&&(te<0||k!==Mu[te]?Kt(it,g,Tu,2):te--)}}},Kt=(f,d,g,C,b=null)=>{const{el:v,type:R,transition:P,children:A,shapeFlag:k}=f;if(k&6){Kt(f.component.subTree,d,g,C);return}if(k&128){f.suspense.move(d,g,C);return}if(k&64){R.move(f,d,g,cs);return}if(R===Ve){s(v,d,g);for(let T=0;T<A.length;T++)Kt(A[T],d,g,C);s(f.anchor,d,g);return}if(R===$i){w(f,d,g);return}if(C!==2&&k&1&&P)if(C===0)P.beforeEnter(v),s(v,d,g),Ie(()=>P.enter(v),b);else{const{leave:T,delayLeave:L,afterLeave:V}=P,q=()=>s(v,d,g),oe=()=>{T(v,()=>{q(),V&&V()})};L?L(v,q,oe):oe()}else s(v,d,g)},rt=(f,d,g,C=!1,b=!1)=>{const{type:v,props:R,ref:P,children:A,dynamicChildren:k,shapeFlag:B,patchFlag:T,dirs:L,cacheIndex:V}=f;if(T===-2&&(b=!1),P!=null&&bi(P,null,g,f,!0),V!=null&&(d.renderCache[V]=void 0),B&256){d.ctx.deactivate(f);return}const q=B&1&&L,oe=!In(f);let te;if(oe&&(te=R&&R.onVnodeBeforeUnmount)&&tt(te,d,f),B&6)u0(f.component,g,C);else{if(B&128){f.suspense.unmount(g,C);return}q&&Lt(f,null,d,"beforeUnmount"),B&64?f.type.remove(f,d,g,cs,C):k&&!k.hasOnce&&(v!==Ve||T>0&&T&64)?ls(k,d,g,!1,!0):(v===Ve&&T&384||!b&&B&16)&&ls(A,d,g),C&&Au(f)}(oe&&(te=R&&R.onVnodeUnmounted)||q)&&Ie(()=>{te&&tt(te,d,f),q&&Lt(f,null,d,"unmounted")},g)},Au=f=>{const{type:d,el:g,anchor:C,transition:b}=f;if(d===Ve){c0(g,C);return}if(d===$i){_(f);return}const v=()=>{r(g),b&&!b.persisted&&b.afterLeave&&b.afterLeave()};if(f.shapeFlag&1&&b&&!b.persisted){const{leave:R,delayLeave:P}=b,A=()=>R(g,v);P?P(f.el,v,A):A()}else v()},c0=(f,d)=>{let g;for(;f!==d;)g=p(f),r(f),f=g;r(d)},u0=(f,d,g)=>{const{bum:C,scope:b,job:v,subTree:R,um:P,m:A,a:k}=f;Ja(A),Ja(k),C&&fi(C),b.stop(),v&&(v.flags|=8,rt(R,f,d,g)),P&&Ie(P,d),Ie(()=>{f.isUnmounted=!0},d),d&&d.pendingBranch&&!d.isUnmounted&&f.asyncDep&&!f.asyncResolved&&f.suspenseId===d.pendingId&&(d.deps--,d.deps===0&&d.resolve())},ls=(f,d,g,C=!1,b=!1,v=0)=>{for(let R=v;R<f.length;R++)rt(f[R],d,g,C,b)},Wr=f=>{if(f.shapeFlag&6)return Wr(f.component.subTree);if(f.shapeFlag&128)return f.suspense.next();const d=p(f.anchor||f.el),g=d&&d[qf];return g?p(g):d};let jo=!1;const Pu=(f,d,g)=>{f==null?d._vnode&&rt(d._vnode,null,null,!0):y(d._vnode||null,f,d,null,null,null,g),d._vnode=f,jo||(jo=!0,xa(),va(),jo=!1)},cs={p:y,um:rt,m:Kt,r:Au,mt:as,mc:H,pc:ie,pbc:X,n:Wr,o:t};let Ru,$u;return{render:Pu,hydrate:Ru,createApp:dh(Pu,Ru)}}function Pi({type:t,props:e},n){return n==="svg"&&t==="foreignObject"||n==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:n}function Dt({effect:t,job:e},n){n?(t.flags|=32,e.flags|=4):(t.flags&=-33,e.flags&=-5)}function kh(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function Ka(t,e,n=!1){const s=t.children,r=e.children;if(G(s)&&G(r))for(let i=0;i<s.length;i++){const o=s[i];let a=r[i];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[i]=kt(r[i]),a.el=o.el),!n&&a.patchFlag!==-2&&Ka(o,a)),a.type===Is&&(a.el=o.el)}}function Sh(t){const e=t.slice(),n=[0];let s,r,i,o,a;const l=t.length;for(s=0;s<l;s++){const u=t[s];if(u!==0){if(r=n[n.length-1],t[r]<u){e[s]=r,n.push(s);continue}for(i=0,o=n.length-1;i<o;)a=i+o>>1,t[n[a]]<u?i=a+1:o=a;u<t[n[i]]&&(i>0&&(e[s]=n[i-1]),n[i]=s)}}for(i=n.length,o=n[i-1];i-- >0;)n[i]=o,o=e[o];return n}function Ga(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:Ga(e)}function Ja(t){if(t)for(let e=0;e<t.length;e++)t[e].flags|=8}const Eh=Symbol.for("v-scx"),Ah=()=>en(Eh);function Ms(t,e,n){return Xa(t,e,n)}function Xa(t,e,n=ae){const{immediate:s,deep:r,flush:i,once:o}=n,a=ye({},n);let l;if(Ls)if(i==="sync"){const p=Ah();l=p.__watcherHandles||(p.__watcherHandles=[])}else if(!e||s)a.once=!0;else return{stop:ht,resume:ht,pause:ht};const u=xe;a.call=(p,m,E)=>Ye(p,u,m,E);let c=!1;i==="post"?a.scheduler=p=>{Ie(p,u&&u.suspense)}:i!=="sync"&&(c=!0,a.scheduler=(p,m)=>{m?p():wi(p)}),a.augmentJob=p=>{e&&(p.flags|=4),c&&(p.flags|=2,u&&(p.id=u.uid,p.i=u))};const h=vf(t,e,a);return l&&l.push(h),h}function Ph(t,e,n){const s=this.proxy,r=ke(t)?t.includes(".")?Za(s,t):()=>s[t]:t.bind(s,s);let i;U(e)?i=e:(i=e.handler,n=e);const o=Bn(this),a=Xa(r,i.bind(s),n);return o(),a}function Za(t,e){const n=e.split(".");return()=>{let s=t;for(let r=0;r<n.length&&s;r++)s=s[n[r]];return s}}const Rh=(t,e)=>e==="modelValue"||e==="model-value"?t.modelModifiers:t[`${e}Modifiers`]||t[`${It(e)}Modifiers`]||t[`${An(e)}Modifiers`];function $h(t,e,...n){if(t.isUnmounted)return;const s=t.vnode.props||ae;let r=n;const i=e.startsWith("update:"),o=i&&Rh(s,e.slice(7));o&&(o.trim&&(r=n.map(c=>ke(c)?c.trim():c)),o.number&&(r=n.map(If)));let a,l=s[a=ui(e)]||s[a=ui(It(e))];!l&&i&&(l=s[a=ui(An(e))]),l&&Ye(l,t,6,r);const u=s[a+"Once"];if(u){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,Ye(u,t,6,r)}}function Qa(t,e,n=!1){const s=e.emitsCache,r=s.get(t);if(r!==void 0)return r;const i=t.emits;let o={},a=!1;if(!U(t)){const l=u=>{const c=Qa(u,e,!0);c&&(a=!0,ye(o,c))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!i&&!a?(pe(t)&&s.set(t,null),null):(G(i)?i.forEach(l=>o[l]=null):ye(o,i),pe(t)&&s.set(t,o),o)}function Ts(t,e){return!t||!li(e)?!1:(e=e.slice(2).replace(/Once$/,""),Q(t,e[0].toLowerCase()+e.slice(1))||Q(t,An(e))||Q(t,e))}function m0(){}function Ri(t){const{type:e,vnode:n,proxy:s,withProxy:r,propsOptions:[i],slots:o,attrs:a,emit:l,render:u,renderCache:c,props:h,data:p,setupState:m,ctx:E,inheritAttrs:y}=t,S=As(t);let I,x;try{if(n.shapeFlag&4){const _=r||s,$=_;I=et(u.call($,_,c,h,m,p,E)),x=a}else{const _=e;I=et(_.length>1?_(h,{attrs:a,slots:o,emit:l}):_(h,null)),x=e.props?a:Mh(a)}}catch(_){Ln.length=0,Es(_,t,1),I=Pe(Bt)}let w=I;if(x&&y!==!1){const _=Object.keys(x),{shapeFlag:$}=w;_.length&&$&7&&(i&&_.some(ca)&&(x=Th(x,i)),w=tn(w,x,!1,!0))}return n.dirs&&(w=tn(w,null,!1,!0),w.dirs=w.dirs?w.dirs.concat(n.dirs):n.dirs),n.transition&&(w.transition=n.transition),I=w,As(S),I}const Mh=t=>{let e;for(const n in t)(n==="class"||n==="style"||li(n))&&((e||(e={}))[n]=t[n]);return e},Th=(t,e)=>{const n={};for(const s in t)(!ca(s)||!(s.slice(9)in e))&&(n[s]=t[s]);return n};function Ih(t,e,n){const{props:s,children:r,component:i}=t,{props:o,children:a,patchFlag:l}=e,u=i.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return s?Ya(s,o,u):!!o;if(l&8){const c=e.dynamicProps;for(let h=0;h<c.length;h++){const p=c[h];if(o[p]!==s[p]&&!Ts(u,p))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:s===o?!1:s?o?Ya(s,o,u):!0:!!o;return!1}function Ya(t,e,n){const s=Object.keys(e);if(s.length!==Object.keys(t).length)return!0;for(let r=0;r<s.length;r++){const i=s[r];if(e[i]!==t[i]&&!Ts(n,i))return!0}return!1}function Oh({vnode:t,parent:e},n){for(;e;){const s=e.subTree;if(s.suspense&&s.suspense.activeBranch===t&&(s.el=t.el),s===t)(t=e.vnode).el=n,e=e.parent;else break}}const el=t=>t.__isSuspense;function Fh(t,e){e&&e.pendingBranch?G(t)?e.effects.push(...t):e.effects.push(t):zf(t)}const Ve=Symbol.for("v-fgt"),Is=Symbol.for("v-txt"),Bt=Symbol.for("v-cmt"),$i=Symbol.for("v-stc"),Ln=[];let Oe=null;function he(t=!1){Ln.push(Oe=t?null:[])}function Lh(){Ln.pop(),Oe=Ln[Ln.length-1]||null}let jn=1;function tl(t){jn+=t,t<0&&Oe&&(Oe.hasOnce=!0)}function nl(t){return t.dynamicChildren=jn>0?Oe||Xt:null,Lh(),jn>0&&Oe&&Oe.push(t),t}function ge(t,e,n,s,r,i){return nl(O(t,e,n,s,r,i,!0))}function sl(t,e,n,s,r){return nl(Pe(t,e,n,s,r,!0))}function jh(t){return t?t.__v_isVNode===!0:!1}function Dn(t,e){return t.type===e.type&&t.key===e.key}const rl=({key:t})=>t??null,Os=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?ke(t)||ce(t)||U(t)?{i:Te,r:t,k:e,f:!!n}:t:null);function O(t,e=null,n=null,s=0,r=null,i=t===Ve?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&rl(e),ref:e&&Os(e),scopeId:ka,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:s,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:Te};return a?(Mi(l,n),i&128&&t.normalize(l)):n&&(l.shapeFlag|=ke(n)?8:16),jn>0&&!o&&Oe&&(l.patchFlag>0||i&6)&&l.patchFlag!==32&&Oe.push(l),l}const Pe=Dh;function Dh(t,e=null,n=null,s=0,r=null,i=!1){if((!t||t===ih)&&(t=Bt),jh(t)){const a=tn(t,e,!0);return n&&Mi(a,n),jn>0&&!i&&Oe&&(a.shapeFlag&6?Oe[Oe.indexOf(t)]=a:Oe.push(a)),a.patchFlag=-2,a}if(Qh(t)&&(t=t.__vccOpts),e){e=Bh(e);let{class:a,style:l}=e;a&&!ke(a)&&(e.class=Pn(a)),pe(l)&&(ii(l)&&!G(l)&&(l=ye({},l)),e.style=hi(l))}const o=ke(t)?1:el(t)?128:Kf(t)?64:pe(t)?4:U(t)?2:0;return O(t,e,n,s,r,o,i,!0)}function Bh(t){return t?ii(t)||Ba(t)?ye({},t):t:null}function tn(t,e,n=!1,s=!1){const{props:r,ref:i,patchFlag:o,children:a,transition:l}=t,u=e?Hh(r||{},e):r,c={__v_isVNode:!0,__v_skip:!0,type:t.type,props:u,key:u&&rl(u),ref:e&&e.ref?n&&i?G(i)?i.concat(Os(e)):[i,Os(e)]:Os(e):i,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:a,target:t.target,targetStart:t.targetStart,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Ve?o===-1?16:o|16:o,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:l,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&tn(t.ssContent),ssFallback:t.ssFallback&&tn(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce};return l&&s&&Sa(c,l.clone(c)),c}function Nh(t=" ",e=0){return Pe(Is,null,t,e)}function nn(t="",e=!1){return e?(he(),sl(Bt,null,t)):Pe(Bt,null,t)}function et(t){return t==null||typeof t=="boolean"?Pe(Bt):G(t)?Pe(Ve,null,t.slice()):typeof t=="object"?kt(t):Pe(Is,null,String(t))}function kt(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:tn(t)}function Mi(t,e){let n=0;const{shapeFlag:s}=t;if(e==null)e=null;else if(G(e))n=16;else if(typeof e=="object")if(s&65){const r=e.default;r&&(r._c&&(r._d=!1),Mi(t,r()),r._c&&(r._d=!0));return}else{n=32;const r=e._;!r&&!Ba(e)?e._ctx=Te:r===3&&Te&&(Te.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else U(e)?(e={default:e,_ctx:Te},n=32):(e=String(e),s&64?(n=16,e=[Nh(e)]):n=8);t.children=e,t.shapeFlag|=n}function Hh(...t){const e={};for(let n=0;n<t.length;n++){const s=t[n];for(const r in s)if(r==="class")e.class!==s.class&&(e.class=Pn([e.class,s.class]));else if(r==="style")e.style=hi([e.style,s.style]);else if(li(r)){const i=e[r],o=s[r];o&&i!==o&&!(G(i)&&i.includes(o))&&(e[r]=i?[].concat(i,o):o)}else r!==""&&(e[r]=s[r])}return e}function tt(t,e,n,s=null){Ye(t,e,7,[n,s])}const Vh=La();let Uh=0;function zh(t,e,n){const s=t.type,r=(e?e.appContext:t.appContext)||Vh,i={uid:Uh++,vnode:t,type:s,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Do(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Ha(s,r),emitsOptions:Qa(s,r),emit:null,emitted:null,propsDefaults:ae,inheritAttrs:s.inheritAttrs,ctx:ae,data:ae,props:ae,attrs:ae,slots:ae,refs:ae,setupState:ae,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=$h.bind(null,i),t.ce&&t.ce(i),i}let xe=null,Fs,Ti;{const t=ga(),e=(n,s)=>{let r;return(r=t[n])||(r=t[n]=[]),r.push(s),i=>{r.length>1?r.forEach(o=>o(i)):r[0](i)}};Fs=e("__VUE_INSTANCE_SETTERS__",n=>xe=n),Ti=e("__VUE_SSR_SETTERS__",n=>Ls=n)}const Bn=t=>{const e=xe;return Fs(t),t.scope.on(),()=>{t.scope.off(),Fs(e)}},il=()=>{xe&&xe.scope.off(),Fs(null)};function ol(t){return t.vnode.shapeFlag&4}let Ls=!1;function Wh(t,e=!1,n=!1){e&&Ti(e);const{props:s,children:r}=t.vnode,i=ol(t);mh(t,s,i,e),yh(t,r,n);const o=i?qh(t,e):void 0;return e&&Ti(!1),o}function qh(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=new Proxy(t.ctx,oh);const{setup:s}=n;if(s){const r=t.setupContext=s.length>1?Gh(t):null,i=Bn(t);at();const o=Zt(s,t,0,[t.props,r]);if(lt(),i(),ha(o)){if(In(t)||Ea(t),o.then(il,il),e)return o.then(a=>{al(t,a,e)}).catch(a=>{Es(a,t,0)});t.asyncDep=o}else al(t,o,e)}else cl(t,e)}function al(t,e,n){U(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:pe(e)&&(t.setupState=la(e)),cl(t,n)}let ll;function cl(t,e,n){const s=t.type;if(!t.render){if(!e&&ll&&!s.render){const r=s.template||ki(t).template;if(r){const{isCustomElement:i,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:l}=s,u=ye(ye({isCustomElement:i,delimiters:a},o),l);s.render=ll(r,u)}}t.render=s.render||ht}{const r=Bn(t);at();try{ah(t)}finally{lt(),r()}}}const Kh={get(t,e){return we(t,"get",""),t[e]}};function Gh(t){const e=n=>{t.exposed=n||{}};return{attrs:new Proxy(t.attrs,Kh),slots:t.slots,emit:t.emit,expose:e}}function js(t){return t.exposed?t.exposeProxy||(t.exposeProxy=new Proxy(la(oi(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in On)return On[n](t)},has(e,n){return n in e||n in On}})):t.proxy}const Jh=/(?:^|[-_])(\w)/g,Xh=t=>t.replace(Jh,e=>e.toUpperCase()).replace(/[-_]/g,"");function Zh(t,e=!0){return U(t)?t.displayName||t.name:t.name||e&&t.__name}function ul(t,e,n=!1){let s=Zh(e);if(!s&&e.__file){const r=e.__file.match(/([^/\\]+)\.\w+$/);r&&(s=r[1])}if(!s&&t&&t.parent){const r=i=>{for(const o in i)if(i[o]===e)return o};s=r(t.components||t.parent.type.components)||r(t.appContext.components)}return s?Xh(s):n?"App":"Anonymous"}function Qh(t){return U(t)&&"__vccOpts"in t}const Ii=(t,e)=>yf(t,e,Ls),Yh="3.5.0-beta.3";/**
* @vue/shared v3.5.0-beta.3
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
...
${c}`:c,i=i?`${i}
${h}`:h;const p=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(h,o,!0),this.lexer.state.top=p,s.length===0)break;const m=o[o.length-1];if((m==null?void 0:m.type)==="code")break;if((m==null?void 0:m.type)==="blockquote"){const E=m,y=E.raw+`
`+s.join(`
`),S=this.blockquote(y);o[o.length-1]=S,r=r.substring(0,r.length-E.raw.length)+S.raw,i=i.substring(0,i.length-E.text.length)+S.text;break}else if((m==null?void 0:m.type)==="list"){const E=m,y=E.raw+`
`+s.join(`
`),S=this.list(y);o[o.length-1]=S,r=r.substring(0,r.length-m.raw.length)+S.raw,i=i.substring(0,i.length-E.raw.length)+S.raw,s=y.substring(o[o.length-1].raw.length).split(`
...
Please report this to https://github.com/markedjs/marked.`,e){const r="<p>An error occurred:</p><pre>"+De(s.message+"",!0)+"</pre>";return n?Promise.resolve(r):r}if(n)return Promise.reject(s);throw s}}}const Wt=new wm;function ee(t,e){return Wt.parse(t,e)}ee.options=ee.setOptions=function(t){return Wt.setOptions(t),ee.defaults=Wt.defaults,cu(ee.defaults),ee},ee.getDefaults=Ro,ee.defaults=zt,ee.use=function(...t){return Wt.use(...t),ee.defaults=Wt.defaults,cu(ee.defaults),ee},ee.walkTokens=function(t,e){return Wt.walkTokens(t,e)},ee.parseInline=Wt.parseInline,ee.Parser=ze,ee.parser=ze.parse,ee.Renderer=Hr,ee.TextRenderer=Lo,ee.Lexer=Ue,ee.lexer=Ue.lex,ee.Tokenizer=jr,ee.Hooks=os,ee.parse=ee,ee.options,ee.setOptions,ee.use,ee.walkTokens,ee.parseInline,ze.parse,Ue.lex;const bm="data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='utf-8'?%3e%3c!--%20Uploaded%20to:%20SVG%20Repo,%20www.svgrepo.com,%20Generator:%20SVG%20Repo%20Mixer%20Tools%20--%3e%3csvg%20width='800px'%20height='800px'%20viewBox='0%200%2024%2024'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20id='Edit%20/%20Edit_Pencil_01'%3e%3cpath%20id='Vector'%20d='M12%208.00012L4%2016.0001V20.0001L8%2020.0001L16%2012.0001M12%208.00012L14.8686%205.13146L14.8704%205.12976C15.2652%204.73488%2015.463%204.53709%2015.691%204.46301C15.8919%204.39775%2016.1082%204.39775%2016.3091%204.46301C16.5369%204.53704%2016.7345%204.7346%2017.1288%205.12892L18.8686%206.86872C19.2646%207.26474%2019.4627%207.46284%2019.5369%207.69117C19.6022%207.89201%2019.6021%208.10835%2019.5369%208.3092C19.4628%208.53736%2019.265%208.73516%2018.8695%209.13061L18.8686%209.13146L16%2012.0001M12%208.00012L16%2012.0001'%20stroke='%23000000'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/g%3e%3c/svg%3e",ym="data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='utf-8'?%3e%3c!--%20Uploaded%20to:%20SVG%20Repo,%20www.svgrepo.com,%20Generator:%20SVG%20Repo%20Mixer%20Tools%20--%3e%3csvg%20width='800px'%20height='800px'%20viewBox='0%200%2024%2024'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20id='Interface%20/%20Trash_Full'%3e%3cpath%20id='Vector'%20d='M14%2010V17M10%2010V17M6%206V17.8C6%2018.9201%206%2019.4798%206.21799%2019.9076C6.40973%2020.2839%206.71547%2020.5905%207.0918%2020.7822C7.5192%2021%208.07899%2021%209.19691%2021H14.8031C15.921%2021%2016.48%2021%2016.9074%2020.7822C17.2837%2020.5905%2017.5905%2020.2839%2017.7822%2019.9076C18%2019.4802%2018%2018.921%2018%2017.8031V6M6%206H8M6%206H4M8%206H16M8%206C8%205.06812%208%204.60241%208.15224%204.23486C8.35523%203.74481%208.74432%203.35523%209.23438%203.15224C9.60192%203%2010.0681%203%2011%203H13C13.9319%203%2014.3978%203%2014.7654%203.15224C15.2554%203.35523%2015.6447%203.74481%2015.8477%204.23486C15.9999%204.6024%2016%205.06812%2016%206M16%206H18M18%206H20'%20stroke='%23000000'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/g%3e%3c/svg%3e",xm={key:0,class:"chat-history-overlay"},vm={class:"chat-history-modal"},Cm={class:"chat-history-search-container"},km={class:"chat-history-content"},Sm={key:0,class:"chat-history-empty-container"},Em={key:1,class:"chat-history-list"},Am=["onMouseenter"],Pm={class:"chat-item-actions"},Rm=["onClick"],$m=["onClick"],Mm=["onClick"],Tm={key:0,class:"chat-title-edit"},Im=["onKeydown","onBlur"],Om={key:1},Fm={class:"chat-title"},Lm={class:"chat-date"},jm=Tn({__name:"ChatHistory",emits:["loadChat"],setup(t,{expose:e,emit:n}){const s=lu(),r=Ae(!1),i=Ae(""),o=Ae(null),a=Ae(null),l=Ae(""),u=Ii(()=>{if(!i.value)return s.chatHistory;const x=i.value.toLowerCase();return s.chatHistory.filter(w=>w.title.toLowerCase().includes(x)||w.messages.some(_=>_.content.toLowerCase().includes(x)))}),c=x=>x?new Date(x).toLocaleString("en-US",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"",h=x=>{a.value===null&&(s.loadChat(x),I())},p=(x,w)=>{x.stopPropagation(),a.value=w.id,l.value=w.title},m=(x,w)=>{if(x.stopPropagation(),l.value.trim()){const _=s.chatHistory.findIndex($=>$.id===w);_!==-1&&(s.chatHistory[_].title=l.value.trim(),s.saveToStorage())}a.value=null,l.value=""},E=x=>{if(confirm("Are you sure you want to delete this chat?")){const w=s.chatHistory.findIndex(_=>_.id===x);w!==-1&&(s.chatHistory.splice(w,1),s.currentChatId===x&&(s.clearMessages(),s.currentChatId=""),s.saveToStorage())}},y=(x,w)=>{x.key==="Enter"?m(x,w):x.key==="Escape"&&(a.value=null,l.value="")},S=()=>{r.value=!0},I=()=>{r.value=!1,o.value=null,a.value=null,l.value=""};return e({show:S,hide:I}),(x,w)=>r.value?(he(),ge("div",xm,[O("div",vm,[O("div",{class:"chat-history-header"},[w[4]||(w[4]=O("h2",{class:"chat-history-title"},"TeacherAIde",-1)),w[5]||(w[5]=O("div",{class:"chat-history-subtitle"},"Chat History",-1)),O("img",{onClick:I,src:Vs,alt:"close",class:"chat-history-close"})]),O("div",Cm,[Ps(O("input",{"onUpdate:modelValue":w[0]||(w[0]=_=>i.value=_),type:"text",placeholder:"Search your chats...",class:"chat-history-search-input"},null,512),[[Ns,i.value]])]),O("div",km,[u.value.length===0?(he(),ge("div",Sm,w[6]||(w[6]=[O("div",{class:"chat-history-empty"},[O("p",null,"Your chat history is currently empty."),O("p",null,"Return to Home screen and start a new conversation!")],-1)]))):(he(),ge("div",Em,[(he(!0),ge(Ve,null,yi(u.value,_=>(he(),ge("div",{key:_.id,class:Pn(["chat-history-item",{active:o.value===_.id}]),onMouseenter:$=>o.value=_.id,onMouseleave:w[3]||(w[3]=$=>o.value=null)},[O("div",Pm,[O("img",{onClick:Hs($=>p($,_),["stop"]),src:bm,alt:"edit",class:"action-icon",title:"Edit title"},null,8,Rm),O("img",{onClick:Hs($=>E(_.id),["stop"]),src:ym,alt:"delete",class:"action-icon",title:"Delete chat"},null,8,$m)]),O("div",{class:"chat-item-content",onClick:$=>h(_.id)},[a.value===_.id?(he(),ge("div",Tm,[Ps(O("input",{"onUpdate:modelValue":w[1]||(w[1]=$=>l.value=$),type:"text",onClick:w[2]||(w[2]=Hs(()=>{},["stop"])),onKeydown:$=>y($,_.id),onBlur:$=>m($,_.id),class:"chat-title-input",ref_for:!0,ref:"editInput"},null,40,Im),[[Ns,l.value]])])):(he(),ge("div",Om,[O("div",Fm,Ot(_.title),1),O("div",Lm,Ot(c(_.timestamp)),1)]))],8,Mm)],42,Am))),128))]))])])])):nn("",!0)}}),Dm=".chat-history-overlay[data-v-099e7435]{position:fixed;top:0;left:0;right:0;bottom:0;background-color:#00000080;display:flex;justify-content:center;align-items:center;z-index:1000}.chat-history-modal[data-v-099e7435]{background-color:#fff;border-radius:12px;width:90%;max-width:500px;height:90vh;display:flex;flex-direction:column;overflow:hidden}.chat-history-header[data-v-099e7435]{padding:20px;border-bottom:1px solid #e5e7eb;position:relative}.chat-history-title[data-v-099e7435]{color:#003274;font-size:24px;font-weight:600;margin:0}.chat-history-subtitle[data-v-099e7435]{color:#93a3bc;font-size:18px;margin-top:4px}.chat-history-close[data-v-099e7435]{position:absolute;top:20px;right:20px;width:15px;height:15px;cursor:pointer}.chat-history-search-container[data-v-099e7435]{padding:12px 20px;border-bottom:1px solid #e5e7eb}.chat-history-search-input[data-v-099e7435]{width:100%;padding:8px 12px;border:1px solid #e5e7eb;border-radius:4px;font-size:14px;outline:none;box-sizing:border-box}.chat-history-search-input[data-v-099e7435]:focus{border-color:#003274}.chat-history-content[data-v-099e7435]{flex:1;overflow-y:auto;padding:20px}.chat-history-empty-container[data-v-099e7435]{height:100%;display:flex;align-items:center;justify-content:center;text-align:center;color:#6b7280}.chat-history-empty[data-v-099e7435]{padding:20px}.chat-history-empty p[data-v-099e7435]{margin:4px 0}.chat-history-list[data-v-099e7435]{display:flex;flex-direction:column;gap:12px}.chat-history-item[data-v-099e7435]{position:relative;background-color:#e7eef7;border-radius:8px;padding:16px 32px 16px 16px;cursor:pointer;transition:all .2s ease}.chat-history-item.active[data-v-099e7435]{background-color:#b8cce8}.chat-item-actions[data-v-099e7435]{position:absolute;top:8px;right:8px;z-index:1;display:flex;gap:8px}.action-icon[data-v-099e7435]{width:16px;height:16px;cursor:pointer;opacity:0;transition:opacity .2s ease}.chat-history-item:hover .action-icon[data-v-099e7435]{opacity:.6}.action-icon[data-v-099e7435]:hover{opacity:1!important}.chat-title-edit[data-v-099e7435]{margin-right:40px}.chat-title-input[data-v-099e7435]{width:100%;padding:4px 8px;border:1px solid #003274;border-radius:4px;font-size:14px;background:#fff;color:#003274}.chat-title-input[data-v-099e7435]:focus{outline:none;border-color:#003274;box-shadow:0 0 0 2px #0032741a}.chat-title[data-v-099e7435]{font-size:16px;color:#1f2937;font-weight:500;margin-bottom:4px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.chat-date[data-v-099e7435]{font-size:12px;color:#6b7280}.chat-history-content[data-v-099e7435]::-webkit-scrollbar{width:6px}.chat-history-content[data-v-099e7435]::-webkit-scrollbar-track{background:transparent}.chat-history-content[data-v-099e7435]::-webkit-scrollbar-thumb{background:#ddd;border-radius:3px}.chat-history-content[data-v-099e7435]::-webkit-scrollbar-thumb:hover{background:#c4c4c4}",Vr=(t,e)=>{const n=t.__vccOpts||t;for(const[s,r]of e)n[s]=r;return n},ku=Vr(jm,[["styles",[Dm]],["__scopeId","data-v-099e7435"]]),Bm={key:0,class:"help-overlay"},Nm={class:"help-modal"},Hm={class:"help-content"},Vm=["onMouseenter","onMouseleave","onClick"],Um={class:"help-question"},zm={key:0,class:"help-answer"},Su=Vr(Tn({__name:"HelpDialog",setup(t,{expose:e}){const n=Ae(!1),s=()=>{n.value=!0},r=()=>{n.value=!1,i.forEach(a=>a.isExpanded=!1)},i=Sn([{id:1,question:"Who is TeacherAIde?",answer:"TeacherAIde is a helpful assistant designed to support teachers in their daily tasks.",isExpanded:!1,isHovered:!1},{id:2,question:"How to copy answer?",answer:"Click the copy icon (clipboard symbol) below any message to copy its content.",isExpanded:!1,isHovered:!1},{id:3,question:"How to regenerate answer?",answer:"Click the refresh icon below any message to generate a new response.",isExpanded:!1,isHovered:!1},{id:4,question:"How to insert answer to editor?",answer:"Click the share icon below any message to insert it into your current document.",isExpanded:!1,isHovered:!1},{id:5,question:"How to retrieve chat history?",answer:"Click the list icon at the bottom left of the screen to view your chat history.",isExpanded:!1,isHovered:!1},{id:6,question:"How to edit or delete chat history?",answer:"In the chat history view, you can click the pen icon to edit chat session name or click the bin icon to delete the chat session from the chat history.",isExpanded:!1,isHovered:!1}]),o=a=>{a.isExpanded=!a.isExpanded};return e({show:s,hide:r}),(a,l)=>n.value?(he(),ge("div",Bm,[O("div",Nm,[O("div",{class:"help-header"},[l[0]||(l[0]=O("h2",{class:"help-title"},"TeacherAIde",-1)),l[1]||(l[1]=O("div",{class:"help-subtitle"},"Help",-1)),O("img",{onClick:r,src:Vs,alt:"close",class:"help-close"})]),O("div",Hm,[(he(!0),ge(Ve,null,yi(i,u=>(he(),ge("div",{key:u.id,class:Pn(["help-item",{active:u.isHovered,expanded:u.isExpanded}]),onMouseenter:c=>u.isHovered=!0,onMouseleave:c=>u.isHovered=!1,onClick:c=>o(u)},[O("div",Um,Ot(u.id)+". "+Ot(u.question),1),u.isExpanded?(he(),ge("div",zm,Ot(u.answer),1)):nn("",!0)],42,Vm))),128))])])])):nn("",!0)}}),[["styles",[".help-overlay[data-v-c830c8ad]{position:fixed;top:0;left:0;right:0;bottom:0;background-color:#00000080;display:flex;justify-content:center;align-items:center;z-index:1000}.help-modal[data-v-c830c8ad]{background-color:#fff;border-radius:12px;width:90%;max-width:500px;height:90vh;display:flex;flex-direction:column;overflow:hidden}.help-header[data-v-c830c8ad]{padding:20px;border-bottom:1px solid #e5e7eb;position:relative}.help-title[data-v-c830c8ad]{color:#003274;font-size:24px;font-weight:600;margin:0}.help-subtitle[data-v-c830c8ad]{color:#93a3bc;font-size:18px;margin-top:4px}.help-close[data-v-c830c8ad]{position:absolute;top:20px;right:20px;width:15px;height:15px;cursor:pointer}.help-content[data-v-c830c8ad]{flex:1;overflow-y:auto;padding:20px}.help-item[data-v-c830c8ad]{background-color:#e7eef7;border-radius:8px;padding:16px;margin-bottom:12px;cursor:pointer;transition:all .2s ease}.help-item.active[data-v-c830c8ad],.help-item.expanded[data-v-c830c8ad]{background-color:#b8cce8}.help-question[data-v-c830c8ad]{font-size:16px;color:#003274;font-weight:500}.help-answer[data-v-c830c8ad]{margin-top:12px;padding-top:12px;border-top:1px solid rgba(0,50,116,.1);color:#4a5568;font-size:14px;line-height:1.4}.help-close[data-v-c830c8ad]:hover{opacity:.8}"]],["__scopeId","data-v-c830c8ad"]]),Wm={class:"chat-container"},qm={class:"messages-container"},Km={key:0,class:"empty-state"},Gm={key:0,class:"user-message"},Jm={class:"message-content"},Xm={key:1,class:"assistant-message"},Zm=["innerHTML"],Qm={class:"bottom-container"},Ym={class:"input-wrapper"},e0={class:"input-area"},t0=Vr(Tn({__name:"SimpleChat",props:{textMessage:{type:String}},emits:["back-to-home"],setup(t,{emit:e}){const n=t,s=e,r=lu(),{client:i,systemPrompt:o}=Ng(),a=Ae(null),l=Ae(null);new AbortController;const u=async()=>{if(!r.newMessage)return;const I=r.newMessage;r.addMessage({content:I,role:"user"}),r.clearNewMessage();try{const x=r.messages,w=await i.chat.completions.create({model:r.selectedModel,messages:x,max_tokens:r.maxTokens});w.choices[0].message.content&&r.addMessage({content:w.choices[0].message.content,role:"assistant"})}catch(x){console.error("Failed to send message:",x)}},c=async I=>{try{r.clearMessages(),r.clearNewMessage(),r.currentChatId="",s("back-to-home")}catch(x){console.error("Failed to return to home:",x)}},h=I=>{r.currentChatId=I.id,r.setUserMessages(I.messages),r.clearNewMessage()},p=async I=>{var x;try{const w=(x=I.target.closest(".assistant-message"))==null?void 0:x.querySelector(".message-content");if(w){const _=w.textContent||"";await navigator.clipboard.writeText(_),alert("Message copied to clipboard!")}else console.warn("Message content not found")}catch(w){console.error("Failed to copy:",w),alert("Failed to copy message. Please try again.")}},m=async I=>{var x;try{const w=document.getElementById("teacheraide-modal-chatbox");if(console.log("parentChatWindow",w),w&&w!=null){const _=w.getAttribute("data-iframe-target")||"";console.log("target iframe ID",_);const $=document.getElementById(_);if($&&$!=null&&$!=null){const N=$.contentDocument;if(N&&N!=null&&N!=null){const j=N.body;if(console.log("iframe body",j),j&&j!=null&&j!=null){const H=(x=I.target.closest(".assistant-message"))==null?void 0:x.querySelector(".message-content");if(H){const D=H.textContent||"";await navigator.clipboard.writeText(D);const X=document.createElement("p");X.innerText=D,j.appendChild(X)}else console.warn("Message content not found")}}}}}catch(w){console.error("Failed to copy:",w)}},E=async I=>{try{if(!a.value){console.warn("Chat history component not initialized");return}await a.value.show(),console.log("Chat history displayed successfully")}catch(x){console.error("Failed to display chat history:",x),alert("Failed to open chat history. Please try again.")}},y=async I=>{try{if(!l.value){console.warn("Help dialog component not initialized");return}await l.value.show(),console.log("Help dialog displayed successfully")}catch(x){console.error("Failed to display help dialog:",x),alert("Failed to open help. Please try again.")}};Ra(()=>{n.textMessage&&(r.newMessage=n.textMessage,u())});const S=()=>{console.log("close window");let I=document.getElementById("chat-screen");I&&(I.style.display="none")};return(I,x)=>(he(),ge("div",Wm,[O("div",{class:"header"},[x[2]||(x[2]=O("h2",{class:"title"},"TeacherAIde",-1)),O("img",{onClick:S,src:Vs,alt:"close",class:"close-icon",title:"close"})]),O("div",qm,[Mt(r).messages.length===0?(he(),ge("div",Km,x[3]||(x[3]=[O("p",null,"You are a helpful assistant that aids teachers.",-1)]))):nn("",!0),(he(!0),ge(Ve,null,yi(Mt(r).messages,(w,_)=>(he(),ge("div",{key:_,class:"message-wrapper"},[w.role==="user"?(he(),ge("div",Gm,[O("div",Jm,Ot(w.content),1)])):nn("",!0),w.role==="assistant"?(he(),ge("div",Xm,[x[4]||(x[4]=O("div",{class:"assistant-label"},"TeacherAIde:",-1)),O("div",{class:"message-content",innerHTML:Mt(ee).parse(w.content)},null,8,Zm),O("div",{class:"message-actions",onClick:x[0]||(x[0]=Hs(()=>{},["stop"]))},[O("img",{onClick:p,src:zd,alt:"copy",class:"action-icon",title:"Copy to clipboard"}),O("img",{onClick:m,src:Wd,alt:"share",class:"action-icon",title:"Copy to editor"})])])):nn("",!0)]))),128))]),O("div",Qm,[O("div",Ym,[O("div",e0,[Ps(O("input",{"onUpdate:modelValue":x[1]||(x[1]=w=>Mt(r).newMessage=w),onKeyup:Rl(u,["enter"]),type:"text",placeholder:"Ask TeacherAIde...",class:"message-input"},null,544),[[Ns,Mt(r).newMessage]]),O("img",{onClick:u,src:Il,alt:"send",class:"send-icon",title:"send"})])]),O("div",{class:"navigation"},[O("img",{onClick:E,src:Ol,alt:"chat history",class:"nav-icon",title:"Chat history"}),O("img",{onClick:c,src:Fl,alt:"home",class:"nav-icon",title:"Start new chat"}),O("img",{onClick:y,src:Ll,alt:"help",class:"nav-icon",title:"Help"})])]),Pe(ku,{ref_key:"chatHistoryRef",ref:a,onLoadChat:h},null,512),Pe(Su,{ref_key:"helpDialogRef",ref:l},null,512)]))}}),[["styles",[".chat-container[data-v-dd662722]{width:90%;max-width:500px;height:90vh;margin:20px auto;background:#fff;border-radius:12px;display:flex;flex-direction:column;border:1px solid #e5e7eb;box-shadow:0 2px 10px #0000001a}.header[data-v-dd662722]{padding:16px 20px;border-bottom:1px solid #e5e7eb;display:flex;justify-content:space-between;align-items:center}.title[data-v-dd662722]{color:#003274;font-size:24px;font-weight:600;margin:0}.close-icon[data-v-dd662722]{width:15px;height:15px;cursor:pointer}.messages-container[data-v-dd662722]{flex:1;overflow-y:auto;padding:16px 20px;display:flex;flex-direction:column;gap:16px}.message-wrapper[data-v-dd662722]{margin-bottom:8px;width:100%}.user-message[data-v-dd662722]{margin-bottom:4px}.user-message .message-content[data-v-dd662722]{color:#003274;text-align:left;font-weight:800}.assistant-message[data-v-dd662722]{background-color:#f8f9fa;padding:16px 20px;margin:0 -20px;position:relative}.assistant-label[data-v-dd662722]{color:#003274;font-weight:800;margin-bottom:4px}.assistant-message .message-content[data-v-dd662722]{color:#000;text-align:left;margin-bottom:24px}.message-content[data-v-dd662722]{line-height:1.4;white-space:pre-wrap}.message-actions[data-v-dd662722]{position:absolute;bottom:8px;left:20px;display:flex;gap:16px;align-items:center}.action-icon[data-v-dd662722]{width:16px;height:16px;cursor:pointer;filter:brightness(0);opacity:.8;transition:opacity .2s ease;padding:2px}.bottom-container[data-v-dd662722]{margin-top:auto}.input-wrapper[data-v-dd662722]{padding:0 20px;margin-bottom:8px}.input-area[data-v-dd662722]{background-color:#003274;border-radius:25px;display:flex;align-items:center;padding:8px 16px}.message-input[data-v-dd662722]{flex:1;padding:8px;border:none;background:transparent;color:#fff;outline:none;font-size:14px}.message-input[data-v-dd662722]::-moz-placeholder{color:#fff;opacity:.8}.message-input[data-v-dd662722]::placeholder{color:#fff;opacity:.8}.send-icon[data-v-dd662722]{width:20px;height:20px;cursor:pointer;margin-left:8px}.navigation[data-v-dd662722]{background:#f8f9fa;padding:12px 20px;display:flex;justify-content:space-between;align-items:center;border-top:1px solid #e5e7eb;border-bottom-left-radius:12px;border-bottom-right-radius:12px}.nav-icon[data-v-dd662722]{width:24px;height:24px;cursor:pointer;transition:opacity .2s ease}.nav-icon[data-v-dd662722]:hover,.send-icon[data-v-dd662722]:hover,.close-icon[data-v-dd662722]:hover{opacity:.8}.messages-container[data-v-dd662722]::-webkit-scrollbar{width:6px}.messages-container[data-v-dd662722]::-webkit-scrollbar-track{background:transparent}.messages-container[data-v-dd662722]::-webkit-scrollbar-thumb{background:#ddd;border-radius:3px}"]],["__scopeId","data-v-dd662722"]]),n0={key:0,class:"home-container"},s0={class:"content-container"},r0={class:"input-container"},i0=Vr(Tn({__name:"HomeScreen",setup(t){const e=Ae(!1),n=Ae(""),s=Ae(null),r=Ae(null),i=async()=>{var c;(c=s.value)==null||c.show()},o=async()=>{var c;(c=r.value)==null||c.show()},a=()=>{n.value.trim()&&(e.value=!0)},l=()=>{e.value=!1,n.value=""},u=()=>{e.value=!1,n.value=""};return(c,h)=>e.value?(he(),sl(t0,{key:1,"text-message":n.value,onBackToHome:u},null,8,["text-message"])):(he(),ge("div",n0,[O("img",{onClick:l,src:Vs,alt:"close",class:"close-icon"}),O("div",s0,[h[1]||(h[1]=O("h1",{class:"title"},"TeacherAIde",-1)),h[2]||(h[2]=O("p",{class:"subtitle"},"Your personal teaching assistant",-1)),O("div",r0,[Ps(O("input",{"onUpdate:modelValue":h[0]||(h[0]=p=>n.value=p),type:"text",placeholder:"Ask TeacherAIde...",class:"ask-input",onKeyup:Rl(a,["enter"])},null,544),[[Ns,n.value]]),O("img",{onClick:a,src:Il,alt:"send",class:"send-icon"})])]),O("div",{class:"navigation"},[O("img",{onClick:i,src:Ol,alt:"chat history",class:"nav-icon",title:"Chat history"}),h[3]||(h[3]=O("img",{src:Fl,alt:"home",class:"nav-icon active",title:"Home"},null,-1)),O("img",{onClick:o,src:Ll,alt:"help",class:"nav-icon",title:"Help"})]),Pe(ku,{ref_key:"chatHistoryRef",ref:s},null,512),Pe(Su,{ref_key:"helpDialogRef",ref:r},null,512)]))}}),[["styles",[".home-container[data-v-48677201]{width:90%;max-width:500px;height:90vh;margin:20px auto;background:#fff;border-radius:12px;display:flex;flex-direction:column;position:relative;border:1px solid #e5e7eb;box-shadow:0 2px 10px #0000001a}.close-icon[data-v-48677201]{position:absolute;top:20px;right:20px;width:15px;height:15px;cursor:pointer}.content-container[data-v-48677201]{flex:1;display:flex;flex-direction:column;justify-content:center;align-items:center;padding:20px}.title[data-v-48677201]{color:#003274;font-size:32px;font-weight:600;margin:0}.subtitle[data-v-48677201]{color:#666;margin-top:8px}.input-container[data-v-48677201]{margin-top:24px;width:calc(100% - 40px);max-width:400px;position:relative}.ask-input[data-v-48677201]{width:calc(100% - 40px);padding:12px 20px;border-radius:25px;border:none;background-color:#003274;color:#fff;font-size:16px;outline:none}.ask-input[data-v-48677201]::-moz-placeholder{color:#fffc}.ask-input[data-v-48677201]::placeholder{color:#fffc}.send-icon[data-v-48677201]{position:absolute;right:12px;top:50%;transform:translateY(-50%);width:24px;height:24px;cursor:pointer}.navigation[data-v-48677201]{padding:12px 20px;display:flex;justify-content:space-between;align-items:center;border-top:1px solid #e5e7eb}.nav-icon[data-v-48677201]{width:24px;height:24px;cursor:pointer;opacity:.5}.nav-icon.active[data-v-48677201]{opacity:1}"]],["__scopeId","data-v-48677201"]]);async function o0({endpoint:t,method:e,params:n}){return ot.call([{methodname:"local_teacheraide_openai_gateway",args:{endpoint:t,method:e,params:n}}])[0]}const Eu=`${M.cfg.wwwroot}/webservice/restful/server.php/local_teacheraide_openai_gateway`,a0=async(t,e)=>{const n=`${t}`.replace(Eu,""),s=e==null?void 0:e.method,r=e==null?void 0:e.body,i=await o0({endpoint:n,method:s,params:r});return new Response(i.data,{status:200,headers:{"Content-Type":"application/json"}})};async function l0({systemPrompt:t}){const e=new ue({baseURL:Eu,apiKey:"dummy",dangerouslyAllowBrowser:!0,fetch:a0}),n=Bg({client:e,systemPrompt:t});customElements.define("teacheraide-simple-chat",Od(i0,{configureApp:n}))}wt.init=l0,Object.defineProperty(wt,Symbol.toStringTag,{value:"Module"})});
