...
Please report this to https://github.com/markedjs/marked.`,e){const r="<p>An error occurred:</p><pre>"+Le(s.message+"",!0)+"</pre>";return n?Promise.resolve(r):r}if(n)return Promise.reject(s);throw s}}}const zt=new mm;function Y(t,e){return zt.parse(t,e)}Y.options=Y.setOptions=function(t){return zt.setOptions(t),Y.defaults=zt.defaults,lu(Y.defaults),Y},Y.getDefaults=ko,Y.defaults=Ut,Y.use=function(...t){return zt.use(...t),Y.defaults=zt.defaults,lu(Y.defaults),Y},Y.walkTokens=function(t,e){return zt.walkTokens(t,e)},Y.parseInline=zt.parseInline,Y.Parser=Ve,Y.parser=Ve.parse,Y.Renderer=Dr,Y.TextRenderer=Mo,Y.Lexer=He,Y.lexer=He.lex,Y.Tokenizer=Or,Y.Hooks=is,Y.parse=Y,Y.options,Y.setOptions,Y.use,Y.walkTokens,Y.parseInline,Ve.parse,He.lex;const _m={key:0,class:"chat-history-overlay"},wm=$n({__name:"ChatHistory",setup(t,{expose:e}){au();const n=Qe(!1),s=()=>{n.value=!0},r=()=>{n.value=!1};return e({show:s,hide:r}),(i,o)=>n.value?(Ce(),Ne("div",_m,[L("div",{class:"chat-history-modal"},[L("div",{class:"chat-history-header"},[o[0]||(o[0]=L("h2",{class:"chat-history-title"},"TeacherAIde",-1)),o[1]||(o[1]=L("div",{class:"chat-history-subtitle"},"Chat History",-1)),L("img",{onClick:r,src:Bs,alt:"close",class:"chat-history-close"})]),o[2]||(o[2]=L("div",{class:"chat-history-content"},[L("div",{class:"chat-history-empty-container"},[L("div",{class:"chat-history-empty"},[L("p",null,"Your chat history is currently empty."),L("p",null,"Return to Home screen and start a new conversation!")])])],-1))])])):jn("",!0)}}),bm=".chat-history-overlay[data-v-03609742]{position:fixed;top:0;left:0;right:0;bottom:0;background-color:#00000080;display:flex;justify-content:center;align-items:center;z-index:1000}.chat-history-modal[data-v-03609742]{background-color:#fff;border-radius:12px;width:90%;max-width:500px;height:90vh;display:flex;flex-direction:column;overflow:hidden;border:1px solid #e5e7eb}.chat-history-header[data-v-03609742]{padding:20px;border-bottom:1px solid #e5e7eb;position:relative}.chat-history-title[data-v-03609742]{color:#003274;font-size:24px;font-weight:600;margin:0}.chat-history-subtitle[data-v-03609742]{color:#93a3bc;font-size:16px;margin-top:4px}.chat-history-close[data-v-03609742]{position:absolute;top:20px;right:20px;width:15px;height:15px;cursor:pointer}.chat-history-content[data-v-03609742]{flex:1;overflow-y:auto;overflow-x:hidden;position:relative}.chat-history-empty-container[data-v-03609742]{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:100%;padding:0 20px}.chat-history-empty[data-v-03609742]{text-align:center;color:#666}.chat-history-empty p[data-v-03609742]{margin:8px 0;line-height:1.5}",Br=(t,e)=>{const n=t.__vccOpts||t;for(const[s,r]of e)n[s]=r;return n},Su=Br(wm,[["styles",[bm]],["__scopeId","data-v-03609742"]]),ym={key:0,class:"help-overlay"},xm={class:"help-modal"},vm={class:"help-content"},Sm=["onMouseenter","onMouseleave","onClick"],km={class:"help-question"},Cm={key:0,class:"help-answer"},ku=Br($n({__name:"HelpDialog",setup(t,{expose:e}){const n=Qe(!1),s=()=>{n.value=!0},r=()=>{n.value=!1,i.forEach(a=>a.isExpanded=!1)},i=Sn([{id:1,question:"Who is TeacherAIde?",answer:"TeacherAIde is a helpful assistant designed to support teachers in their daily tasks.",isExpanded:!1,isHovered:!1},{id:2,question:"How to copy answer?",answer:"Click the copy icon (clipboard symbol) below any message to copy its content.",isExpanded:!1,isHovered:!1},{id:3,question:"How to regenerate answer?",answer:"Click the refresh icon below any message to generate a new response.",isExpanded:!1,isHovered:!1},{id:4,question:"How to insert answer to editor?",answer:"Click the share icon below any message to insert it into your current document.",isExpanded:!1,isHovered:!1},{id:5,question:"How to retrieve chat history?",answer:"Click the list icon at the bottom left of the screen to view your chat history.",isExpanded:!1,isHovered:!1},{id:6,question:"How to edit or delete chat history?",answer:"In the chat history view, you can click the pen icon to edit chat session name or click the bin icon to delete the chat session from the chat history.",isExpanded:!1,isHovered:!1}]),o=a=>{a.isExpanded=!a.isExpanded};return e({show:s,hide:r}),(a,l)=>n.value?(Ce(),Ne("div",ym,[L("div",xm,[L("div",{class:"help-header"},[l[0]||(l[0]=L("h2",{class:"help-title"},"TeacherAIde",-1)),l[1]||(l[1]=L("div",{class:"help-subtitle"},"Help",-1)),L("img",{onClick:r,src:Bs,alt:"close",class:"help-close"})]),L("div",vm,[(Ce(!0),Ne(We,null,Aa(i,u=>(Ce(),Ne("div",{key:u.id,class:Cs(["help-item",{active:u.isHovered,expanded:u.isExpanded}]),onMouseenter:c=>u.isHovered=!0,onMouseleave:c=>u.isHovered=!1,onClick:c=>o(u)},[L("div",km,En(u.id)+". "+En(u.question),1),u.isExpanded?(Ce(),Ne("div",Cm,En(u.answer),1)):jn("",!0)],42,Sm))),128))])])])):jn("",!0)}}),[["styles",[".help-overlay[data-v-c830c8ad]{position:fixed;top:0;left:0;right:0;bottom:0;background-color:#00000080;display:flex;justify-content:center;align-items:center;z-index:1000}.help-modal[data-v-c830c8ad]{background-color:#fff;border-radius:12px;width:90%;max-width:500px;height:90vh;display:flex;flex-direction:column;overflow:hidden}.help-header[data-v-c830c8ad]{padding:20px;border-bottom:1px solid #e5e7eb;position:relative}.help-title[data-v-c830c8ad]{color:#003274;font-size:24px;font-weight:600;margin:0}.help-subtitle[data-v-c830c8ad]{color:#93a3bc;font-size:18px;margin-top:4px}.help-close[data-v-c830c8ad]{position:absolute;top:20px;right:20px;width:15px;height:15px;cursor:pointer}.help-content[data-v-c830c8ad]{flex:1;overflow-y:auto;padding:20px}.help-item[data-v-c830c8ad]{background-color:#e7eef7;border-radius:8px;padding:16px;margin-bottom:12px;cursor:pointer;transition:all .2s ease}.help-item.active[data-v-c830c8ad],.help-item.expanded[data-v-c830c8ad]{background-color:#b8cce8}.help-question[data-v-c830c8ad]{font-size:16px;color:#003274;font-weight:500}.help-answer[data-v-c830c8ad]{margin-top:12px;padding-top:12px;border-top:1px solid rgba(0,50,116,.1);color:#4a5568;font-size:14px;line-height:1.4}.help-close[data-v-c830c8ad]:hover{opacity:.8}"]],["__scopeId","data-v-c830c8ad"]]),Em={class:"chat-container"},Am={class:"messages-container"},Rm={key:0,class:"empty-state"},Pm={key:0,class:"user-message"},$m={class:"message-content"},Mm={key:1,class:"assistant-message"},Tm=["innerHTML"],Im={class:"bottom-container"},Om={class:"input-wrapper"},Fm={class:"input-area"},Lm=Br($n({__name:"SimpleChat",props:{textMessage:{type:String}},emits:["back-to-home"],setup(t,{emit:e}){const n=t,s=au(),{client:r,systemPrompt:i}=Dg(),o=Qe(null),a=Qe(null),l=new AbortController,u=async()=>{if(!s.newMessage)return;const T=s.newMessage;s.addMessage({content:T,role:"user"}),s.clearNewMessage();try{const A=await r.chat.completions.create({model:s.selectedModel,messages:s.messages,max_tokens:s.maxTokens},{signal:l.signal});s.addMessage({content:A.choices[0].message.content,role:"assistant"})}catch(A){console.error("Failed to send message:",A)}},c=async T=>{var A,P;try{const _=(P=(A=T.target.closest(".inline-block.p-2.rounded-lg"))==null?void 0:A.querySelector("p"))==null?void 0:P.textContent;_?(await navigator.clipboard.writeText(_),alert(`copied ${_} to clipboard!`)):console.warn("No text found in <p> tag")}catch(_){console.error("Failed to copy:",_)}},h=async T=>{var A,P;try{const _=(P=(A=T.target.closest(".inline-block.p-2.rounded-lg"))==null?void 0:A.querySelector("p"))==null?void 0:P.textContent;_?(await navigator.clipboard.writeText(_),alert(`copied ${_} to clipboard!`)):console.warn("No text found in <p> tag")}catch(_){console.error("Failed to copy:",_)}},p=async T=>{var A,P;try{const _=(P=(A=T.target.closest(".inline-block.p-2.rounded-lg"))==null?void 0:A.querySelector("p"))==null?void 0:P.textContent;_?(await navigator.clipboard.writeText(_),alert(`copied ${_} to clipboard!`)):console.warn("No text found in <p> tag")}catch(_){console.error("Failed to copy:",_)}},m=async T=>{try{if(!o.value){console.warn("Chat history component not initialized");return}await o.value.show(),console.log("Chat history displayed successfully")}catch(A){console.error("Failed to display chat history:",A),alert("Failed to open chat history. Please try again.")}},k=async T=>{try{console.log("Home navigation to be implemented"),alert("Home navigation coming soon!")}catch(A){console.error("Failed to navigate home:",A)}},b=async T=>{try{if(!a.value){console.warn("Help dialog component not initialized");return}await a.value.show(),console.log("Help dialog displayed successfully")}catch(A){console.error("Failed to display help dialog:",A),alert("Failed to open help. Please try again.")}};Ca(()=>{n.textMessage&&(s.newMessage=n.textMessage,u())});const S=()=>{console.log("close window");let T=document.getElementById("chat-screen");T&&(T.style.display="none")};return(T,A)=>(Ce(),Ne("div",Em,[L("div",{class:"header"},[A[1]||(A[1]=L("h2",{class:"title"},"TeacherAIde",-1)),L("img",{onClick:S,src:Bs,alt:"close",class:"close-icon",title:"close"})]),L("div",Am,[Mt(s).messages.length===0?(Ce(),Ne("div",Rm,A[2]||(A[2]=[L("p",null,"You are a helpful assistant that aids teachers.",-1)]))):(Ce(!0),Ne(We,{key:1},Aa(Mt(s).messages,(P,_)=>(Ce(),Ne("div",{key:_,class:"message-wrapper"},[P.role==="user"?(Ce(),Ne("div",Pm,[L("div",$m,En(P.content),1)])):jn("",!0),P.role==="assistant"?(Ce(),Ne("div",Mm,[A[3]||(A[3]=L("div",{class:"assistant-label"},"TeacherAIde:",-1)),L("div",{class:"message-content",innerHTML:Mt(Y).parse(P.content)},null,8,Tm),L("div",{class:"message-actions"},[L("img",{onClick:c,src:Hd,alt:"copy",class:"action-icon",title:"copy"}),L("img",{onClick:h,src:Vd,alt:"refresh",class:"action-icon",title:"refresh"}),L("img",{onClick:p,src:Ud,alt:"share",class:"action-icon",title:"share"})])])):jn("",!0)]))),128))]),L("div",Im,[L("div",Om,[L("div",Fm,[ya(L("input",{"onUpdate:modelValue":A[0]||(A[0]=P=>Mt(s).newMessage=P),onKeyup:Rl(u,["enter"]),type:"text",placeholder:"Ask TeacherAIde...",class:"message-input"},null,544),[[Al,Mt(s).newMessage]]),L("img",{onClick:u,src:Tl,alt:"send",class:"send-icon",title:"send"})])]),L("div",{class:"navigation"},[L("img",{onClick:m,src:Il,alt:"chat history",class:"nav-icon",title:"chat history"}),L("img",{onClick:k,src:Ol,alt:"home",class:"nav-icon",title:"home"}),L("img",{onClick:b,src:Fl,alt:"help",class:"nav-icon",title:"help"})])]),Ee(Su,{ref_key:"chatHistoryRef",ref:o},null,512),Ee(ku,{ref_key:"helpDialogRef",ref:a},null,512)]))}}),[["styles",[".chat-container[data-v-37252304]{width:90%;max-width:500px;height:90vh;margin:20px auto;background:#fff;border-radius:12px;display:flex;flex-direction:column;border:1px solid #e5e7eb;box-shadow:0 2px 10px #0000001a}.header[data-v-37252304]{padding:16px 20px;border-bottom:1px solid #e5e7eb;display:flex;justify-content:space-between;align-items:center}.title[data-v-37252304]{color:#003274;font-size:24px;font-weight:600;margin:0}.close-icon[data-v-37252304]{width:15px;height:15px;cursor:pointer}.messages-container[data-v-37252304]{flex:1;overflow-y:auto;padding:16px 32px;display:flex;flex-direction:column;gap:16px}.message-wrapper[data-v-37252304]{margin-bottom:8px;width:100%}.user-message[data-v-37252304]{margin-bottom:4px}.user-message .message-content[data-v-37252304]{color:#003274;text-align:left;font-weight:800}.assistant-message[data-v-37252304]{background-color:#f8f9fa;padding:16px 32px;margin:0 -32px;position:relative}.assistant-label[data-v-37252304]{color:#003274;font-weight:800;margin-bottom:4px}.assistant-message .message-content[data-v-37252304]{color:#000;text-align:left;margin-bottom:24px}.message-content[data-v-37252304]{line-height:1.4;white-space:pre-wrap}.message-content[data-v-37252304] p{margin:8px 0}.message-content[data-v-37252304] p:first-child{margin-top:0}.message-content[data-v-37252304] ul{margin:4px 0;padding-left:16px}.message-content[data-v-37252304] li{margin:2px 0}.message-actions[data-v-37252304]{position:absolute;bottom:8px;left:32px;display:flex;gap:16px;align-items:center}.action-icon[data-v-37252304]{width:16px;height:16px;cursor:pointer;filter:brightness(0);opacity:.8;transition:opacity .2s ease;padding:2px}.action-icon[data-v-37252304]:hover{opacity:1}.empty-state[data-v-37252304]{text-align:center;color:#666;padding:16px}.bottom-container[data-v-37252304]{margin-top:auto}.input-wrapper[data-v-37252304]{padding:0 16px;margin-bottom:8px}.input-area[data-v-37252304]{background-color:#003274;border-radius:25px;display:flex;align-items:center;padding:8px 16px}.message-input[data-v-37252304]{flex:1;padding:8px;border:none;background:transparent;color:#fff;outline:none;font-size:14px}.message-input[data-v-37252304]::-moz-placeholder{color:#fff;opacity:.8}.message-input[data-v-37252304]::placeholder{color:#fff;opacity:.8}.send-icon[data-v-37252304]{width:20px;height:20px;cursor:pointer;margin-left:8px}.navigation[data-v-37252304]{background:#f8f9fa;padding:12px 20px;display:flex;justify-content:space-between;align-items:center;border-top:1px solid #e5e7eb;border-bottom-left-radius:12px;border-bottom-right-radius:12px}.nav-icon[data-v-37252304]{width:24px;height:24px;cursor:pointer;transition:opacity .2s ease}.nav-icon[data-v-37252304]:hover,.send-icon[data-v-37252304]:hover,.close-icon[data-v-37252304]:hover{opacity:.8}.messages-container[data-v-37252304]::-webkit-scrollbar{width:6px}.messages-container[data-v-37252304]::-webkit-scrollbar-track{background:transparent}.messages-container[data-v-37252304]::-webkit-scrollbar-thumb{background:#ddd;border-radius:3px}"]],["__scopeId","data-v-37252304"]]),jm={key:0,class:"home-container"},Dm={class:"content-container"},Bm={class:"input-container"},Nm=Br($n({__name:"HomeScreen",setup(t){const e=Qe(!1),n=Qe(""),s=Qe(null),r=Qe(null),i=async()=>{var c;(c=s.value)==null||c.show()},o=async()=>{var c;(c=r.value)==null||c.show()},a=()=>{n.value.trim()&&(e.value=!0)},l=()=>{e.value=!1,n.value=""},u=()=>{e.value=!1,n.value=""};return(c,h)=>e.value?(Ce(),el(Lm,{key:1,"text-message":n.value,onBackToHome:u},null,8,["text-message"])):(Ce(),Ne("div",jm,[L("img",{onClick:l,src:Bs,alt:"close",class:"close-icon"}),L("div",Dm,[h[1]||(h[1]=L("h1",{class:"title"},"TeacherAIde",-1)),h[2]||(h[2]=L("p",{class:"subtitle"},"Your personal teaching assistant",-1)),L("div",Bm,[ya(L("input",{"onUpdate:modelValue":h[0]||(h[0]=p=>n.value=p),type:"text",placeholder:"Ask TeacherAIde...",class:"ask-input",onKeyup:Rl(a,["enter"])},null,544),[[Al,n.value]]),L("img",{onClick:a,src:Tl,alt:"send",class:"send-icon"})])]),L("div",{class:"navigation"},[L("img",{onClick:i,src:Il,alt:"chat history",class:"nav-icon"}),h[3]||(h[3]=L("img",{src:Ol,alt:"home",class:"nav-icon active"},null,-1)),L("img",{onClick:o,src:Fl,alt:"help",class:"nav-icon"})]),Ee(Su,{ref_key:"chatHistoryRef",ref:s},null,512),Ee(ku,{ref_key:"helpDialogRef",ref:r},null,512)]))}}),[["styles",[".home-container[data-v-f9e94673]{width:90%;max-width:500px;height:90vh;margin:20px auto;background:#fff;border-radius:12px;display:flex;flex-direction:column;position:relative;border:1px solid #e5e7eb;box-shadow:0 2px 10px #0000001a}.close-icon[data-v-f9e94673]{position:absolute;top:20px;right:20px;width:15px;height:15px;cursor:pointer}.content-container[data-v-f9e94673]{flex:1;display:flex;flex-direction:column;justify-content:center;align-items:center;padding:20px}.title[data-v-f9e94673]{color:#003274;font-size:32px;font-weight:600;margin:0}.subtitle[data-v-f9e94673]{color:#666;margin-top:8px}.input-container[data-v-f9e94673]{margin-top:24px;width:100%;max-width:400px;position:relative}.ask-input[data-v-f9e94673]{width:100%;padding:12px 40px 12px 16px;border-radius:25px;border:none;background-color:#003274;color:#fff;font-size:16px;outline:none}.ask-input[data-v-f9e94673]::-moz-placeholder{color:#fffc}.ask-input[data-v-f9e94673]::placeholder{color:#fffc}.send-icon[data-v-f9e94673]{position:absolute;right:12px;top:50%;transform:translateY(-50%);width:24px;height:24px;cursor:pointer}.navigation[data-v-f9e94673]{padding:12px 20px;display:flex;justify-content:space-between;align-items:center;border-top:1px solid #e5e7eb}.nav-icon[data-v-f9e94673]{width:24px;height:24px;cursor:pointer;opacity:.5}.nav-icon.active[data-v-f9e94673]{opacity:1}"]],["__scopeId","data-v-f9e94673"]]);async function Hm({endpoint:t,method:e,params:n}){return ot.call([{methodname:"local_teacheraide_openai_gateway",args:{endpoint:t,method:e,params:n}}])[0]}const Cu=`${M.cfg.wwwroot}/webservice/restful/server.php/local_teacheraide_openai_gateway`,Vm=async(t,e)=>{const n=`${t}`.replace(Cu,""),s=e==null?void 0:e.method,r=e==null?void 0:e.body,i=await Hm({endpoint:n,method:s,params:r});return new Response(i.data,{status:200,headers:{"Content-Type":"application/json"}})};async function Um({systemPrompt:t}){const e=new ue({baseURL:Cu,apiKey:"dummy",dangerouslyAllowBrowser:!0,fetch:Vm}),n=jg({client:e,systemPrompt:t});customElements.define("teacheraide-simple-chat",Id(Nm,{configureApp:n}))}wt.init=Um,Object.defineProperty(wt,Symbol.toStringTag,{value:"Module"})});
